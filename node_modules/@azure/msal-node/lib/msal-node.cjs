/*! @azure/msal-node v3.2.3 2025-02-18 */
'use strict';
'use strict';
...
class ClientApplication {
    ...
    async acquireTokenSilent(request) {
        ...
        try {
            const clientConfiguration = await this.buildOauthClientConfiguration(validRequest.authority, validRequest.correlationId, validRequest.redirectUri || "", serverTelemetryManager, undefined, validRequest.azureCloudOptions);
...
class MachineLearning extends BaseManagedIdentitySource {
    constructor(logger, nodeStorage, networkClient, cryptoProvider, msiEndpoint, secret) {
        super(logger, nodeStorage, networkClient, cryptoProvider);
        this.msiEndpoint = msiEndpoint;
        this.secret = secret;
    }
    ...
    static tryCreate(logger, nodeStorage, networkClient, cryptoProvider) {
        ...
        return new MachineLearning(logger, nodeStorage, networkClient, cryptoProvider, msiEndpoint, secret);
    }
    createRequest(resource, managedIdentityId) {
...
class ManagedIdentityClient {
    ...
    selectManagedIdentitySource(logger, nodeStorage, networkClient, cryptoProvider, managedIdentityId) {
        const source = ServiceFabric.tryCreate(logger, nodeStorage, networkClient, cryptoProvider, managedIdentityId) ||
            ...
            MachineLearning.tryCreate(logger, nodeStorage, networkClient, cryptoProvider) ||
