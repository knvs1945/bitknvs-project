...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:Si,depthTest:!1,depthWrite:!1})}function su(){return new Ai({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:Yl(),fragmentShader:`
		...
		`,blending:Si,depthTest:!1,depthWrite:!1})}function ou(){return new Ai({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Yl(),fragmentShader:`
...
`)}function jg(r,t){let e;switch(t){case pd:e="Linear";break;case md:e="Reinhard";break;case _d:e="Cineon";break;case gd:e="ACESFilmic";break;case xd:e="AgX";break;case yd:e="Neutral";break;case vd:e="Custom";break;default:console.warn("THREE.WebGLProgram: Unsupported toneMapping:",t),e="Linear"}return"vec3 "+r+"( vec3 color ) { return "+e+"ToneMapping( color ); }"}const eo=new N;function Qg(){Yt.getLuminanceCoefficients(eo);const r=eo.x.toFixed(4),t=eo.y.toFixed(4),e=eo.z.toFixed(4);return["float luminance( const in vec3 rgb ) {",`	const vec3 weights = vec3( ${r}, ${t}, ${e} );`,"	return dot( weights, rgb );","}"].join(`
`)}function t0(r){return[r.extensionClipCullDistance?"#extension GL_ANGLE_clip_cull_distance : require":"",r.extensionMultiDraw?"#extension GL_ANGLE_multi_draw : require":""].filter(as).join(`
...
#define LOW_PRECISION`),t}function l0(r){let t="SHADOWMAP_TYPE_BASIC";return r.shadowMapType===nh?t="SHADOWMAP_TYPE_PCF":r.shadowMapType===Yf?t="SHADOWMAP_TYPE_PCF_SOFT":r.shadowMapType===Zn&&(t="SHADOWMAP_TYPE_VSM"),t}function c0(r){let t="ENVMAP_TYPE_CUBE";if(r.envMap)switch(r.envMapMode){case Ur:case Nr:t="ENVMAP_TYPE_CUBE";break;case Ro:t="ENVMAP_TYPE_CUBE_UV";break}return t}function u0(r){let t="ENVMAP_MODE_REFLECTION";if(r.envMap)switch(r.envMapMode){case Nr:t="ENVMAP_MODE_REFRACTION";break}return t}function h0(r){let t="ENVMAP_BLENDING_NONE";if(r.envMap)switch(r.combine){case ih:t="ENVMAP_BLENDING_MULTIPLY";break;case fd:t="ENVMAP_BLENDING_MIX";break;case dd:t="ENVMAP_BLENDING_ADD";break}return t}function f0(r){const t=r.envMapCubeUVHeight;if(t===null)return null;const e=Math.log2(t)-2,n=1/t;return{texelWidth:1/(3*Math.max(Math.pow(2,e),7*16)),texelHeight:n,maxMip:e}}function d0(r,t,e,n){const i=r.getContext(),s=e.defines;let o=e.vertexShader,a=e.fragmentShader;const l=l0(e),c=c0(e),u=u0(e),h=h0(e),f=f0(e),p=t0(e),g=e0(s),_=i.createProgram();let m,d,E=e.glslVersion?"#version "+e.glslVersion+`
...
*/var ln={autoSleep:120,force3D:"auto",nullTargetWarn:1,units:{lineHeight:""}},zr={duration:.5,overwrite:!1,delay:0},tc,Re,le,gn=1e8,ne=1/gn,yl=Math.PI*2,Fv=yl/4,Bv=0,Vh=Math.sqrt,zv=Math.cos,kv=Math.sin,Ae=function(t){return typeof t=="string"},de=function(t){return typeof t=="function"},si=function(t){return typeof t=="number"},ec=function(t){return typeof t>"u"},Bn=function(t){return typeof t=="object"},We=function(t){return t!==!1},nc=function(){return typeof window<"u"},so=function(t){return de(t)||Ae(t)},Hh=typeof ArrayBuffer=="function"&&ArrayBuffer.isView||function(){},Ue=Array.isArray,Sl=/(?:-?\.?\d|\.)+/gi,Gh=/[-+=.]*\d+[.e\-+]*\d*[e\-+]*\d*/g,Er=/[-+=.]*\d+[.e-]*\d*[a-z%]*/g,ga=/[-+=.]*\d+\.?\d*(?:e-|e\+)?\d*/gi,Wh=/[+-]=-?[.\d]+/,Xh=/[^,'"\[\]\s]+/gi,Vv=/^[+\-=e\s\d]*\d+[.\d]*([a-z]*|%)\s*$/i,ce,Dn,Ml,ic,cn={},yo={},qh,Yh=function(t){return(yo=kr(t,cn))&&Ke},rc=function(t,e){return console.warn("Invalid property",t,"set to",e,"Missing plugin? gsap.registerPlugin()")},Ss=function(t,e){return!e&&console.warn(t)},Zh=function(t,e){return t&&(cn[t]=e)&&yo&&(yo[t]=e)||cn},Ms=function(){return 0},Hv={suppressEvents:!0,isStart:!0,kill:!1},po={suppressEvents:!0,kill:!1},Gv={suppressEvents:!0},sc={},Ei=[],El={},Kh,Qe={},va={},Uu=30,mo=[],oc="",ac=function(t){var e=t[0],n,i;if(Bn(e)||de(e)||(t=[t]),!(n=(e._gsap||{}).harness)){for(i=mo.length;i--&&!mo[i].targetTest(e););n=mo[i]}for(i=t.length;i--;)t[i]&&(t[i]._gsap||(t[i]._gsap=new yf(t[i],n)))||t.splice(i,1);return t},Ki=function(t){return t._gsap||ac(vn(t))[0]._gsap},$h=function(t,e,n){return(n=t[e])&&de(n)?t[e]():ec(n)&&t.getAttribute&&t.getAttribute(e)||n},Xe=function(t,e){return(t=t.split(",")).forEach(e)||t},me=function(t){return Math.round(t*1e5)/1e5||0},xe=function(t){return Math.round(t*1e7)/1e7||0},Cr=function(t,e){var n=e.charAt(0),i=parseFloat(e.substr(2));return t=parseFloat(t),n==="+"?t+i:n==="-"?t-i:n==="*"?t*i:t/i},Wv=function(t,e){for(var n=e.length,i=0;t.indexOf(e[i])<0&&++i<n;);return i<n},So=function(){var t=Ei.length,e=Ei.slice(0),n,i;for(El={},Ei.length=0,n=0;n<t;n++)i=e[n],i&&i._lazy&&(i.render(i._lazy[0],i._lazy[1],!0)._lazy=0)},Jh=function(t,e,n,i){Ei.length&&!Re&&So(),t.render(e,n,Re&&e<0&&(t._initted||t._startAt)),Ei.length&&!Re&&So()},jh=function(t){var e=parseFloat(t);return(e||e===0)&&(t+"").match(Xh).length<2?e:Ae(t)?t.trim():t},Qh=function(t){return t},un=function(t,e){for(var n in e)n in t||(t[n]=e[n]);return t},Xv=function(t){return function(e,n){for(var i in n)i in e||i==="duration"&&t||i==="ease"||(e[i]=n[i])}},kr=function(t,e){for(var n in e)t[n]=e[n];return t},Nu=function r(t,e){for(var n in e)n!=="__proto__"&&n!=="constructor"&&n!=="prototype"&&(t[n]=Bn(e[n])?r(t[n]||(t[n]={}),e[n]):e[n]);return t},Mo=function(t,e){var n={},i;for(i in t)i in e||(n[i]=t[i]);return n},ps=function(t){var e=t.parent||ce,n=t.keyframes?Xv(Ue(t.keyframes)):un;if(We(t.inherit))for(;e;)n(t,e.vars.defaults),e=e.parent||e._dp;return t},qv=function(t,e){for(var n=t.length,i=n===e.length;i&&n--&&t[n]===e[n];);return n<0},tf=function(t,e,n,i,s){var o=t[i],a;if(s)for(a=e[s];o&&o[s]>a;)o=o._prev;return o?(e._next=o._next,o._next=e):(e._next=t[n],t[n]=e),e._next?e._next._prev=e:t[i]=e,e._prev=o,e.parent=e._dp=t,e},Uo=function(t,e,n,i){n===void 0&&(n="_first"),i===void 0&&(i="_last");var s=e._prev,o=e._next;s?s._next=o:t[n]===e&&(t[n]=o),o?o._prev=s:t[i]===e&&(t[i]=s),e._next=e._prev=e.parent=null},wi=function(t,e){t.parent&&(!e||t.parent.autoRemoveChildren)&&t.parent.remove&&t.parent.remove(t),t._act=0},$i=function(t,e){if(t&&(!e||e._end>t._dur||e._start<0))for(var n=t;n;)n._dirty=1,n=n.parent;return t},Yv=function(t){for(var e=t.parent;e&&e.parent;)e._dirty=1,e.totalDuration(),e=e.parent;return t},Tl=function(t,e,n,i){return t._startAt&&(Re?t._startAt.revert(po):t.vars.immediateRender&&!t.vars.autoRevert||t._startAt.render(e,!0,i))},Zv=function r(t){return!t||t._ts&&r(t.parent)},Ou=function(t){return t._repeat?Vr(t._tTime,t=t.duration()+t._rDelay)*t:0},Vr=function(t,e){var n=Math.floor(t=xe(t/e));return t&&n===t?n-1:n},Eo=function(t,e){return(t-e._start)*e._ts+(e._ts>=0?0:e._dirty?e.totalDuration():e._tDur)},No=function(t){return t._end=xe(t._start+(t._tDur/Math.abs(t._ts||t._rts||ne)||0))},Oo=function(t,e){var n=t._dp;return n&&n.smoothChildTiming&&t._ts&&(t._start=xe(n._time-(t._ts>0?e/t._ts:((t._dirty?t.totalDuration():t._tDur)-e)/-t._ts)),No(t),n._dirty||$i(n,t)),t},ef=function(t,e){var n;if((e._time||!e._dur&&e._initted||e._start<t._time&&(e._dur||!e.add))&&(n=Eo(t.rawTime(),e),(!e._dur||Ls(0,e.totalDuration(),n)-e._tTime>ne)&&e.render(n,!0)),$i(t,e)._dp&&t._initted&&t._time>=t._dur&&t._ts){if(t._dur<t.duration())for(n=t;n._dp;)n.rawTime()>=0&&n.totalTime(n._tTime),n=n._dp;t._zTime=-ne}},In=function(t,e,n,i){return e.parent&&wi(e),e._start=xe((si(n)?n:n||t!==ce?dn(t,n,e):t._time)+e._delay),e._end=xe(e._start+(e.totalDuration()/Math.abs(e.timeScale())||0)),tf(t,e,"_first","_last",t._sort?"_start":0),bl(e)||(t._recent=e),i||ef(t,e),t._ts<0&&Oo(t,t._tTime),t},nf=function(t,e){return(cn.ScrollTrigger||rc("scrollTrigger",e))&&cn.ScrollTrigger.create(e,t)},rf=function(t,e,n,i,s){if(cc(t,e,s),!t._initted)return 1;if(!n&&t._pt&&!Re&&(t._dur&&t.vars.lazy!==!1||!t._dur&&t.vars.lazy)&&Kh!==rn.frame)return Ei.push(t),t._lazy=[s,i],1},Kv=function r(t){var e=t.parent;return e&&e._ts&&e._initted&&!e._lock&&(e.rawTime()<0||r(e))},bl=function(t){var e=t.data;return e==="isFromStart"||e==="isStart"},$v=function(t,e,n,i){var s=t.ratio,o=e<0||!e&&(!t._start&&Kv(t)&&!(!t._initted&&bl(t))||(t._ts<0||t._dp._ts<0)&&!bl(t))?0:1,a=t._rDelay,l=0,c,u,h;if(a&&t._repeat&&(l=Ls(0,t._tDur,e),u=Vr(l,a),t._yoyo&&u&1&&(o=1-o),u!==Vr(t._tTime,a)&&(s=1-o,t.vars.repeatRefresh&&t._initted&&t.invalidate())),o!==s||Re||i||t._zTime===ne||!e&&t._zTime){if(!t._initted&&rf(t,e,i,n,l))return;for(h=t._zTime,t._zTime=e||(n?ne:0),n||(n=e&&!h),t.ratio=o,t._from&&(o=1-o),t._time=0,t._tTime=l,c=t._pt;c;)c.r(o,c.d),c=c._next;e<0&&Tl(t,e,n,!0),t._onUpdate&&!n&&on(t,"onUpdate"),l&&t._repeat&&!n&&t.parent&&on(t,"onRepeat"),(e>=t._tDur||e<0)&&t.ratio===o&&(o&&wi(t,1),!n&&!Re&&(on(t,o?"onComplete":"onReverseComplete",!0),t._prom&&t._prom()))}else t._zTime||(t._zTime=e)},Jv=function(t,e,n){var i;if(n>e)for(i=t._first;i&&i._start<=n;){if(i.data==="isPause"&&i._start>e)return i;i=i._next}else for(i=t._last;i&&i._start>=n;){if(i.data==="isPause"&&i._start<e)return i;i=i._prev}},Hr=function(t,e,n,i){var s=t._repeat,o=xe(e)||0,a=t._tTime/t._tDur;return a&&!i&&(t._time*=o/t._dur),t._dur=o,t._tDur=s?s<0?1e10:xe(o*(s+1)+t._rDelay*s):o,a>0&&!i&&Oo(t,t._tTime=t._tDur*a),t.parent&&No(t),n||$i(t.parent,t),t},Fu=function(t){return t instanceof ze?$i(t):Hr(t,t._dur)},jv={_start:0,endTime:Ms,totalDuration:Ms},dn=function r(t,e,n){var i=t.labels,s=t._recent||jv,o=t.duration()>=gn?s.endTime(!1):t._dur,a,l,c;return Ae(e)&&(isNaN(e)||e in i)?(l=e.charAt(0),c=e.substr(-1)==="%",a=e.indexOf("="),l==="<"||l===">"?(a>=0&&(e=e.replace(/=/,"")),(l==="<"?s._start:s.endTime(s._repeat>=0))+(parseFloat(e.substr(1))||0)*(c?(a<0?s:n).totalDuration()/100:1)):a<0?(e in i||(i[e]=o),i[e]):(l=parseFloat(e.charAt(a-1)+e.substr(a+1)),c&&n&&(l=l/100*(Ue(n)?n[0]:n).totalDuration()),a>1?r(t,e.substr(0,a-1),n)+l:o+l)):e==null?o:+e},ms=function(t,e,n){var i=si(e[1]),s=(i?2:1)+(t<2?0:1),o=e[s],a,l;if(i&&(o.duration=e[1]),o.parent=n,t){for(a=o,l=n;l&&!("immediateRender"in a);)a=l.vars.defaults||{},l=We(l.vars.inherit)&&l.parent;o.immediateRender=We(a.immediateRender),t<2?o.runBackwards=1:o.startAt=e[s-1]}return new ve(e[0],o,e[s+1])},Ci=function(t,e){return t||t===0?e(t):e},Ls=function(t,e,n){return n<t?t:n>e?e:n},Ie=function(t,e){return!Ae(t)||!(e=Vv.exec(t))?"":e[1]},Qv=function(t,e,n){return Ci(n,function(i){return Ls(t,e,i)})},Al=[].slice,sf=function(t,e){return t&&Bn(t)&&"length"in t&&(!e&&!t.length||t.length-1 in t&&Bn(t[0]))&&!t.nodeType&&t!==Dn},tx=function(t,e,n){return n===void 0&&(n=[]),t.forEach(function(i){var s;return Ae(i)&&!e||sf(i,1)?(s=n).push.apply(s,vn(i)):n.push(i)})||n},vn=function(t,e,n){return le&&!e&&le.selector?le.selector(t):Ae(t)&&!n&&(Ml||!Gr())?Al.call((e||ic).querySelectorAll(t),0):Ue(t)?tx(t,n):sf(t)?Al.call(t,0):t?[t]:[]},wl=function(t){return t=vn(t)[0]||Ss("Invalid scope")||{},function(e){var n=t.current||t.nativeElement||t;return vn(e,n.querySelectorAll?n:n===t?Ss("Invalid scope")||ic.createElement("div"):t)}},of=function(t){return t.sort(function(){return .5-Math.random()})},af=function(t){if(de(t))return t;var e=Bn(t)?t:{each:t},n=Ji(e.ease),i=e.from||0,s=parseFloat(e.base)||0,o={},a=i>0&&i<1,l=isNaN(i)||a,c=e.axis,u=i,h=i;return Ae(i)?u=h={center:.5,edges:.5,end:1}[i]||0:!a&&l&&(u=i[0],h=i[1]),function(f,p,g){var _=(g||e).length,m=o[_],d,E,x,v,R,w,b,C,y;if(!m){if(y=e.grid==="auto"?0:(e.grid||[1,gn])[1],!y){for(b=-gn;b<(b=g[y++].getBoundingClientRect().left)&&y<_;);y<_&&y--}for(m=o[_]=[],d=l?Math.min(y,_)*u-.5:i%y,E=y===gn?0:l?_*h/y-.5:i/y|0,b=0,C=gn,w=0;w<_;w++)x=w%y-d,v=E-(w/y|0),m[w]=R=c?Math.abs(c==="y"?v:x):Vh(x*x+v*v),R>b&&(b=R),R<C&&(C=R);i==="random"&&of(m),m.max=b-C,m.min=C,m.v=_=(parseFloat(e.amount)||parseFloat(e.each)*(y>_?_-1:c?c==="y"?_/y:y:Math.max(y,_/y))||0)*(i==="edges"?-1:1),m.b=_<0?s-_:s,m.u=Ie(e.amount||e.each)||0,n=n&&_<0?gf(n):n}return _=(m[f]-m.min)/m.max||0,xe(m.b+(n?n(_):_)*m.v)+m.u}},Rl=function(t){var e=Math.pow(10,((t+"").split(".")[1]||"").length);return function(n){var i=xe(Math.round(parseFloat(n)/t)*t*e);return(i-i%1)/e+(si(n)?0:Ie(n))}},lf=function(t,e){var n=Ue(t),i,s;return!n&&Bn(t)&&(i=n=t.radius||gn,t.values?(t=vn(t.values),(s=!si(t[0]))&&(i*=i)):t=Rl(t.increment)),Ci(e,n?de(t)?function(o){return s=t(o),Math.abs(s-o)<=i?s:o}:function(o){for(var a=parseFloat(s?o.x:o),l=parseFloat(s?o.y:0),c=gn,u=0,h=t.length,f,p;h--;)s?(f=t[h].x-a,p=t[h].y-l,f=f*f+p*p):f=Math.abs(t[h]-a),f<c&&(c=f,u=h);return u=!i||c<=i?t[u]:o,s||u===o||si(o)?u:u+Ie(o)}:Rl(t))},cf=function(t,e,n,i){return Ci(Ue(t)?!e:n===!0?!!(n=0):!i,function(){return Ue(t)?t[~~(Math.random()*t.length)]:(n=n||1e-5)&&(i=n<1?Math.pow(10,(n+"").length-2):1)&&Math.floor(Math.round((t-n/2+Math.random()*(e-t+n*.99))/n)*n*i)/i})},ex=function(){for(var t=arguments.length,e=new Array(t),n=0;n<t;n++)e[n]=arguments[n];return function(i){return e.reduce(function(s,o){return o(s)},i)}},nx=function(t,e){return function(n){return t(parseFloat(n))+(e||Ie(n))}},ix=function(t,e,n){return hf(t,e,0,1,n)},uf=function(t,e,n){return Ci(n,function(i){return t[~~e(i)]})},rx=function r(t,e,n){var i=e-t;return Ue(t)?uf(t,r(0,t.length),e):Ci(n,function(s){return(i+(s-t)%i)%i+t})},sx=function r(t,e,n){var i=e-t,s=i*2;return Ue(t)?uf(t,r(0,t.length-1),e):Ci(n,function(o){return o=(s+(o-t)%s)%s||0,t+(o>i?s-o:o)})},Es=function(t){for(var e=0,n="",i,s,o,a;~(i=t.indexOf("random(",e));)o=t.indexOf(")",i),a=t.charAt(i+7)==="[",s=t.substr(i+7,o-i-7).match(a?Xh:Sl),n+=t.substr(e,i-e)+cf(a?s:+s[0],a?0:+s[1],+s[2]||1e-5),e=o+1;return n+t.substr(e,t.length-e)},hf=function(t,e,n,i,s){var o=e-t,a=i-n;return Ci(s,function(l){return n+((l-t)/o*a||0)})},ox=function r(t,e,n,i){var s=isNaN(t+e)?0:function(p){return(1-p)*t+p*e};if(!s){var o=Ae(t),a={},l,c,u,h,f;if(n===!0&&(i=1)&&(n=null),o)t={p:t},e={p:e};else if(Ue(t)&&!Ue(e)){for(u=[],h=t.length,f=h-2,c=1;c<h;c++)u.push(r(t[c-1],t[c]));h--,s=function(g){g*=h;var _=Math.min(f,~~g);return u[_](g-_)},n=e}else i||(t=kr(Ue(t)?[]:{},t));if(!u){for(l in e)lc.call(a,t,l,"get",e[l]);s=function(g){return fc(g,a)||(o?t.p:t)}}}return Ci(n,s)},Bu=function(t,e,n){var i=t.labels,s=gn,o,a,l;for(o in i)a=i[o]-e,a<0==!!n&&a&&s>(a=Math.abs(a))&&(l=o,s=a);return l},on=function(t,e,n){var i=t.vars,s=i[e],o=le,a=t._ctx,l,c,u;if(s)return l=i[e+"Params"],c=i.callbackScope||t,n&&Ei.length&&So(),a&&(le=a),u=l?s.apply(c,l):s.call(c),le=o,u},ls=function(t){return wi(t),t.scrollTrigger&&t.scrollTrigger.kill(!!Re),t.progress()<1&&on(t,"onInterrupt"),t},Tr,ff=[],df=function(t){if(t)if(t=!t.name&&t.default||t,nc()||t.headless){var e=t.name,n=de(t),i=e&&!n&&t.init?function(){this._props=[]}:t,s={init:Ms,render:fc,add:lc,kill:Mx,modifier:Sx,rawVars:0},o={targetTest:0,get:0,getSetter:hc,aliases:{},register:0};if(Gr(),t!==i){if(Qe[e])return;un(i,un(Mo(t,s),o)),kr(i.prototype,kr(s,Mo(t,o))),Qe[i.prop=e]=i,t.targetTest&&(mo.push(i),sc[e]=1),e=(e==="css"?"CSS":e.charAt(0).toUpperCase()+e.substr(1))+"Plugin"}Zh(e,i),t.register&&t.register(Ke,i,qe)}else ff.push(t)},ee=255,cs={aqua:[0,ee,ee],lime:[0,ee,0],silver:[192,192,192],black:[0,0,0],maroon:[128,0,0],teal:[0,128,128],blue:[0,0,ee],navy:[0,0,128],white:[ee,ee,ee],olive:[128,128,0],yellow:[ee,ee,0],orange:[ee,165,0],gray:[128,128,128],purple:[128,0,128],green:[0,128,0],red:[ee,0,0],pink:[ee,192,203],cyan:[0,ee,ee],transparent:[ee,ee,ee,0]},xa=function(t,e,n){return t+=t<0?1:t>1?-1:0,(t*6<1?e+(n-e)*t*6:t<.5?n:t*3<2?e+(n-e)*(2/3-t)*6:e)*ee+.5|0},pf=function(t,e,n){var i=t?si(t)?[t>>16,t>>8&ee,t&ee]:0:cs.black,s,o,a,l,c,u,h,f,p,g;if(!i){if(t.substr(-1)===","&&(t=t.substr(0,t.length-1)),cs[t])i=cs[t];else if(t.charAt(0)==="#"){if(t.length<6&&(s=t.charAt(1),o=t.charAt(2),a=t.charAt(3),t="#"+s+s+o+o+a+a+(t.length===5?t.charAt(4)+t.charAt(4):"")),t.length===9)return i=parseInt(t.substr(1,6),16),[i>>16,i>>8&ee,i&ee,parseInt(t.substr(7),16)/255];t=parseInt(t.substr(1),16),i=[t>>16,t>>8&ee,t&ee]}else if(t.substr(0,3)==="hsl"){if(i=g=t.match(Sl),!e)l=+i[0]%360/360,c=+i[1]/100,u=+i[2]/100,o=u<=.5?u*(c+1):u+c-u*c,s=u*2-o,i.length>3&&(i[3]*=1),i[0]=xa(l+1/3,s,o),i[1]=xa(l,s,o),i[2]=xa(l-1/3,s,o);else if(~t.indexOf("="))return i=t.match(Gh),n&&i.length<4&&(i[3]=1),i}else i=t.match(Sl)||cs.transparent;i=i.map(Number)}return e&&!g&&(s=i[0]/ee,o=i[1]/ee,a=i[2]/ee,h=Math.max(s,o,a),f=Math.min(s,o,a),u=(h+f)/2,h===f?l=c=0:(p=h-f,c=u>.5?p/(2-h-f):p/(h+f),l=h===s?(o-a)/p+(o<a?6:0):h===o?(a-s)/p+2:(s-o)/p+4,l*=60),i[0]=~~(l+.5),i[1]=~~(c*100+.5),i[2]=~~(u*100+.5)),n&&i.length<4&&(i[3]=1),i},mf=function(t){var e=[],n=[],i=-1;return t.split(Ti).forEach(function(s){var o=s.match(Er)||[];e.push.apply(e,o),n.push(i+=o.length+1)}),e.c=n,e},zu=function(t,e,n){var i="",s=(t+i).match(Ti),o=e?"hsla(":"rgba(",a=0,l,c,u,h;if(!s)return t;if(s=s.map(function(f){return(f=pf(f,e,1))&&o+(e?f[0]+","+f[1]+"%,"+f[2]+"%,"+f[3]:f.join(","))+")"}),n&&(u=mf(t),l=n.c,l.join(i)!==u.c.join(i)))for(c=t.replace(Ti,"1").split(Er),h=c.length-1;a<h;a++)i+=c[a]+(~l.indexOf(a)?s.shift()||o+"0,0,0,0)":(u.length?u:s.length?s:n).shift());if(!c)for(c=t.split(Ti),h=c.length-1;a<h;a++)i+=c[a]+s[a];return i+c[h]},Ti=function(){var r="(?:\\b(?:(?:rgb|rgba|hsl|hsla)\\(.+?\\))|\\B#(?:[0-9a-f]{3,4}){1,2}\\b",t;for(t in cs)r+="|"+t+"\\b";return new RegExp(r+")","gi")}(),ax=/hsl[a]?\(/,_f=function(t){var e=t.join(" "),n;if(Ti.lastIndex=0,Ti.test(e))return n=ax.test(e),t[1]=zu(t[1],n),t[0]=zu(t[0],n,mf(t[1])),!0},Ts,rn=function(){var r=Date.now,t=500,e=33,n=r(),i=n,s=1e3/240,o=s,a=[],l,c,u,h,f,p,g=function _(m){var d=r()-i,E=m===!0,x,v,R,w;if((d>t||d<0)&&(n+=d-e),i+=d,R=i-n,x=R-o,(x>0||E)&&(w=++h.frame,f=R-h.time*1e3,h.time=R=R/1e3,o+=x+(x>=s?4:s-x),v=1),E||(l=c(_)),v)for(p=0;p<a.length;p++)a[p](R,f,w,m)};return h={time:0,frame:0,tick:function(){g(!0)},deltaRatio:function(m){return f/(1e3/(m||60))},wake:function(){qh&&(!Ml&&nc()&&(Dn=Ml=window,ic=Dn.document||{},cn.gsap=Ke,(Dn.gsapVersions||(Dn.gsapVersions=[])).push(Ke.version),Yh(yo||Dn.GreenSockGlobals||!Dn.gsap&&Dn||{}),ff.forEach(df)),u=typeof requestAnimationFrame<"u"&&requestAnimationFrame,l&&h.sleep(),c=u||function(m){return setTimeout(m,o-h.time*1e3+1|0)},Ts=1,g(2))},sleep:function(){(u?cancelAnimationFrame:clearTimeout)(l),Ts=0,c=Ms},lagSmoothing:function(m,d){t=m||1/0,e=Math.min(d||33,t)},fps:function(m){s=1e3/(m||240),o=h.time*1e3+s},add:function(m,d,E){var x=d?function(v,R,w,b){m(v,R,w,b),h.remove(x)}:m;return h.remove(m),a[E?"unshift":"push"](x),Gr(),x},remove:function(m,d){~(d=a.indexOf(m))&&a.splice(d,1)&&p>=d&&p--},_listeners:a},h}(),Gr=function(){return!Ts&&rn.wake()},Gt={},lx=/^[\d.\-M][\d.\-,\s]/,cx=/["']/g,ux=function(t){for(var e={},n=t.substr(1,t.length-3).split(":"),i=n[0],s=1,o=n.length,a,l,c;s<o;s++)l=n[s],a=s!==o-1?l.lastIndexOf(","):l.length,c=l.substr(0,a),e[i]=isNaN(c)?c.replace(cx,"").trim():+c,i=l.substr(a+1).trim();return e},hx=function(t){var e=t.indexOf("(")+1,n=t.indexOf(")"),i=t.indexOf("(",e);return t.substring(e,~i&&i<n?t.indexOf(")",n+1):n)},fx=function(t){var e=(t+"").split("("),n=Gt[e[0]];return n&&e.length>1&&n.config?n.config.apply(null,~t.indexOf("{")?[ux(e[1])]:hx(t).split(",").map(jh)):Gt._CE&&lx.test(t)?Gt._CE("",t):n},gf=function(t){return function(e){return 1-t(1-e)}},vf=function r(t,e){for(var n=t._first,i;n;)n instanceof ze?r(n,e):n.vars.yoyoEase&&(!n._yoyo||!n._repeat)&&n._yoyo!==e&&(n.timeline?r(n.timeline,e):(i=n._ease,n._ease=n._yEase,n._yEase=i,n._yoyo=e)),n=n._next},Ji=function(t,e){return t&&(de(t)?t:Gt[t]||fx(t))||e},ir=function(t,e,n,i){n===void 0&&(n=function(l){return 1-e(1-l)}),i===void 0&&(i=function(l){return l<.5?e(l*2)/2:1-e((1-l)*2)/2});var s={easeIn:e,easeOut:n,easeInOut:i},o;return Xe(t,function(a){Gt[a]=cn[a]=s,Gt[o=a.toLowerCase()]=n;for(var l in s)Gt[o+(l==="easeIn"?".in":l==="easeOut"?".out":".inOut")]=Gt[a+"."+l]=s[l]}),s},xf=function(t){return function(e){return e<.5?(1-t(1-e*2))/2:.5+t((e-.5)*2)/2}},ya=function r(t,e,n){var i=e>=1?e:1,s=(n||(t?.3:.45))/(e<1?e:1),o=s/yl*(Math.asin(1/i)||0),a=function(u){return u===1?1:i*Math.pow(2,-10*u)*kv((u-o)*s)+1},l=t==="out"?a:t==="in"?function(c){return 1-a(1-c)}:xf(a);return s=yl/s,l.config=function(c,u){return r(t,c,u)},l},Sa=function r(t,e){e===void 0&&(e=1.70158);var n=function(o){return o?--o*o*((e+1)*o+e)+1:0},i=t==="out"?n:t==="in"?function(s){return 1-n(1-s)}:xf(n);return i.config=function(s){return r(t,s)},i};Xe("Linear,Quad,Cubic,Quart,Quint,Strong",function(r,t){var e=t<5?t+1:t;ir(r+",Power"+(e-1),t?function(n){return Math.pow(n,e)}:function(n){return n},function(n){return 1-Math.pow(1-n,e)},function(n){return n<.5?Math.pow(n*2,e)/2:1-Math.pow((1-n)*2,e)/2})});Gt.Linear.easeNone=Gt.none=Gt.Linear.easeIn;ir("Elastic",ya("in"),ya("out"),ya());(function(r,t){var e=1/t,n=2*e,i=2.5*e,s=function(a){return a<e?r*a*a:a<n?r*Math.pow(a-1.5/t,2)+.75:a<i?r*(a-=2.25/t)*a+.9375:r*Math.pow(a-2.625/t,2)+.984375};ir("Bounce",function(o){return 1-s(1-o)},s)})(7.5625,2.75);ir("Expo",function(r){return Math.pow(2,10*(r-1))*r+r*r*r*r*r*r*(1-r)});ir("Circ",function(r){return-(Vh(1-r*r)-1)});ir("Sine",function(r){return r===1?1:-zv(r*Fv)+1});ir("Back",Sa("in"),Sa("out"),Sa());Gt.SteppedEase=Gt.steps=cn.SteppedEase={config:function(t,e){t===void 0&&(t=1);var n=1/t,i=t+(e?0:1),s=e?1:0,o=1-ne;return function(a){return((i*Ls(0,o,a)|0)+s)*n}}};zr.ease=Gt["quad.out"];Xe("onComplete,onUpdate,onStart,onRepeat,onReverseComplete,onInterrupt",function(r){return oc+=r+","+r+"Params,"});var yf=function(t,e){this.id=Bv++,t._gsap=this,this.target=t,this.harness=e,this.get=e?e.get:$h,this.set=e?e.getSetter:hc},bs=function(){function r(e){this.vars=e,this._delay=+e.delay||0,(this._repeat=e.repeat===1/0?-2:e.repeat||0)&&(this._rDelay=e.repeatDelay||0,this._yoyo=!!e.yoyo||!!e.yoyoEase),this._ts=1,Hr(this,+e.duration,1,1),this.data=e.data,le&&(this._ctx=le,le.data.push(this)),Ts||rn.wake()}var t=r.prototype;return t.delay=function(n){return n||n===0?(this.parent&&this.parent.smoothChildTiming&&this.startTime(this._start+n-this._delay),this._delay=n,this):this._delay},t.duration=function(n){return arguments.length?this.totalDuration(this._repeat>0?n+(n+this._rDelay)*this._repeat:n):this.totalDuration()&&this._dur},t.totalDuration=function(n){return arguments.length?(this._dirty=0,Hr(this,this._repeat<0?n:(n-this._repeat*this._rDelay)/(this._repeat+1))):this._tDur},t.totalTime=function(n,i){if(Gr(),!arguments.length)return this._tTime;var s=this._dp;if(s&&s.smoothChildTiming&&this._ts){for(Oo(this,n),!s._dp||s.parent||ef(s,this);s&&s.parent;)s.parent._time!==s._start+(s._ts>=0?s._tTime/s._ts:(s.totalDuration()-s._tTime)/-s._ts)&&s.totalTime(s._tTime,!0),s=s.parent;!this.parent&&this._dp.autoRemoveChildren&&(this._ts>0&&n<this._tDur||this._ts<0&&n>0||!this._tDur&&!n)&&In(this._dp,this,this._start-this._delay)}return(this._tTime!==n||!this._dur&&!i||this._initted&&Math.abs(this._zTime)===ne||!n&&!this._initted&&(this.add||this._ptLookup))&&(this._ts||(this._pTime=n),Jh(this,n,i)),this},t.time=function(n,i){return arguments.length?this.totalTime(Math.min(this.totalDuration(),n+Ou(this))%(this._dur+this._rDelay)||(n?this._dur:0),i):this._time},t.totalProgress=function(n,i){return arguments.length?this.totalTime(this.totalDuration()*n,i):this.totalDuration()?Math.min(1,this._tTime/this._tDur):this.rawTime()>=0&&this._initted?1:0},t.progress=function(n,i){return arguments.length?this.totalTime(this.duration()*(this._yoyo&&!(this.iteration()&1)?1-n:n)+Ou(this),i):this.duration()?Math.min(1,this._time/this._dur):this.rawTime()>0?1:0},t.iteration=function(n,i){var s=this.duration()+this._rDelay;return arguments.length?this.totalTime(this._time+(n-1)*s,i):this._repeat?Vr(this._tTime,s)+1:1},t.timeScale=function(n,i){if(!arguments.length)return this._rts===-ne?0:this._rts;if(this._rts===n)return this;var s=this.parent&&this._ts?Eo(this.parent._time,this):this._tTime;return this._rts=+n||0,this._ts=this._ps||n===-ne?0:this._rts,this.totalTime(Ls(-Math.abs(this._delay),this._tDur,s),i!==!1),No(this),Yv(this)},t.paused=function(n){return arguments.length?(this._ps!==n&&(this._ps=n,n?(this._pTime=this._tTime||Math.max(-this._delay,this.rawTime()),this._ts=this._act=0):(Gr(),this._ts=this._rts,this.totalTime(this.parent&&!this.parent.smoothChildTiming?this.rawTime():this._tTime||this._pTime,this.progress()===1&&Math.abs(this._zTime)!==ne&&(this._tTime-=ne)))),this):this._ps},t.startTime=function(n){if(arguments.length){this._start=n;var i=this.parent||this._dp;return i&&(i._sort||!this.parent)&&In(i,this,n-this._delay),this}return this._start},t.endTime=function(n){return this._start+(We(n)?this.totalDuration():this.duration())/Math.abs(this._ts||1)},t.rawTime=function(n){var i=this.parent||this._dp;return i?n&&(!this._ts||this._repeat&&this._time&&this.totalProgress()<1)?this._tTime%(this._dur+this._rDelay):this._ts?Eo(i.rawTime(n),this):this._tTime:this._tTime},t.revert=function(n){n===void 0&&(n=Gv);var i=Re;return Re=n,(this._initted||this._startAt)&&(this.timeline&&this.timeline.revert(n),this.totalTime(-.01,n.suppressEvents)),this.data!=="nested"&&n.kill!==!1&&this.kill(),Re=i,this},t.globalTime=function(n){for(var i=this,s=arguments.length?n:i.rawTime();i;)s=i._start+s/(Math.abs(i._ts)||1),i=i._dp;return!this.parent&&this._sat?this._sat.globalTime(n):s},t.repeat=function(n){return arguments.length?(this._repeat=n===1/0?-2:n,Fu(this)):this._repeat===-2?1/0:this._repeat},t.repeatDelay=function(n){if(arguments.length){var i=this._time;return this._rDelay=n,Fu(this),i?this.time(i):this}return this._rDelay},t.yoyo=function(n){return arguments.length?(this._yoyo=n,this):this._yoyo},t.seek=function(n,i){return this.totalTime(dn(this,n),We(i))},t.restart=function(n,i){return this.play().totalTime(n?-this._delay:0,We(i)),this._dur||(this._zTime=-ne),this},t.play=function(n,i){return n!=null&&this.seek(n,i),this.reversed(!1).paused(!1)},t.reverse=function(n,i){return n!=null&&this.seek(n||this.totalDuration(),i),this.reversed(!0).paused(!1)},t.pause=function(n,i){return n!=null&&this.seek(n,i),this.paused(!0)},t.resume=function(){return this.paused(!1)},t.reversed=function(n){return arguments.length?(!!n!==this.reversed()&&this.timeScale(-this._rts||(n?-ne:0)),this):this._rts<0},t.invalidate=function(){return this._initted=this._act=0,this._zTime=-ne,this},t.isActive=function(){var n=this.parent||this._dp,i=this._start,s;return!!(!n||this._ts&&this._initted&&n.isActive()&&(s=n.rawTime(!0))>=i&&s<this.endTime(!0)-ne)},t.eventCallback=function(n,i,s){var o=this.vars;return arguments.length>1?(i?(o[n]=i,s&&(o[n+"Params"]=s),n==="onUpdate"&&(this._onUpdate=i)):delete o[n],this):o[n]},t.then=function(n){var i=this;return new Promise(function(s){var o=de(n)?n:Qh,a=function(){var c=i.then;i.then=null,de(o)&&(o=o(i))&&(o.then||o===i)&&(i.then=c),s(o),i.then=c};i._initted&&i.totalProgress()===1&&i._ts>=0||!i._tTime&&i._ts<0?a():i._prom=a})},t.kill=function(){ls(this)},r}();un(bs.prototype,{_time:0,_start:0,_end:0,_tTime:0,_tDur:0,_dirty:0,_repeat:0,_yoyo:!1,parent:null,_initted:!1,_rDelay:0,_ts:1,_dp:0,ratio:0,_zTime:-ne,_prom:0,_ps:!1,_rts:1});var ze=function(r){kh(t,r);function t(n,i){var s;return n===void 0&&(n={}),s=r.call(this,n)||this,s.labels={},s.smoothChildTiming=!!n.smoothChildTiming,s.autoRemoveChildren=!!n.autoRemoveChildren,s._sort=We(n.sortChildren),ce&&In(n.parent||ce,Kn(s),i),n.reversed&&s.reverse(),n.paused&&s.paused(!0),n.scrollTrigger&&nf(Kn(s),n.scrollTrigger),s}var e=t.prototype;return e.to=function(i,s,o){return ms(0,arguments,this),this},e.from=function(i,s,o){return ms(1,arguments,this),this},e.fromTo=function(i,s,o,a){return ms(2,arguments,this),this},e.set=function(i,s,o){return s.duration=0,s.parent=this,ps(s).repeatDelay||(s.repeat=0),s.immediateRender=!!s.immediateRender,new ve(i,s,dn(this,o),1),this},e.call=function(i,s,o){return In(this,ve.delayedCall(0,i,s),o)},e.staggerTo=function(i,s,o,a,l,c,u){return o.duration=s,o.stagger=o.stagger||a,o.onComplete=c,o.onCompleteParams=u,o.parent=this,new ve(i,o,dn(this,l)),this},e.staggerFrom=function(i,s,o,a,l,c,u){return o.runBackwards=1,ps(o).immediateRender=We(o.immediateRender),this.staggerTo(i,s,o,a,l,c,u)},e.staggerFromTo=function(i,s,o,a,l,c,u,h){return a.startAt=o,ps(a).immediateRender=We(a.immediateRender),this.staggerTo(i,s,a,l,c,u,h)},e.render=function(i,s,o){var a=this._time,l=this._dirty?this.totalDuration():this._tDur,c=this._dur,u=i<=0?0:xe(i),h=this._zTime<0!=i<0&&(this._initted||!c),f,p,g,_,m,d,E,x,v,R,w,b;if(this!==ce&&u>l&&i>=0&&(u=l),u!==this._tTime||o||h){if(a!==this._time&&c&&(u+=this._time-a,i+=this._time-a),f=u,v=this._start,x=this._ts,d=!x,h&&(c||(a=this._zTime),(i||!s)&&(this._zTime=i)),this._repeat){if(w=this._yoyo,m=c+this._rDelay,this._repeat<-1&&i<0)return this.totalTime(m*100+i,s,o);if(f=xe(u%m),u===l?(_=this._repeat,f=c):(R=xe(u/m),_=~~R,_&&_===R&&(f=c,_--),f>c&&(f=c)),R=Vr(this._tTime,m),!a&&this._tTime&&R!==_&&this._tTime-R*m-this._dur<=0&&(R=_),w&&_&1&&(f=c-f,b=1),_!==R&&!this._lock){var C=w&&R&1,y=C===(w&&_&1);if(_<R&&(C=!C),a=C?0:u%c?c:u,this._lock=1,this.render(a||(b?0:xe(_*m)),s,!c)._lock=0,this._tTime=u,!s&&this.parent&&on(this,"onRepeat"),this.vars.repeatRefresh&&!b&&(this.invalidate()._lock=1),a&&a!==this._time||d!==!this._ts||this.vars.onRepeat&&!this.parent&&!this._act)return this;if(c=this._dur,l=this._tDur,y&&(this._lock=2,a=C?c:-1e-4,this.render(a,!0),this.vars.repeatRefresh&&!b&&this.invalidate()),this._lock=0,!this._ts&&!d)return this;vf(this,b)}}if(this._hasPause&&!this._forcing&&this._lock<2&&(E=Jv(this,xe(a),xe(f)),E&&(u-=f-(f=E._start))),this._tTime=u,this._time=f,this._act=!x,this._initted||(this._onUpdate=this.vars.onUpdate,this._initted=1,this._zTime=i,a=0),!a&&f&&!s&&!_&&(on(this,"onStart"),this._tTime!==u))return this;if(f>=a&&i>=0)for(p=this._first;p;){if(g=p._next,(p._act||f>=p._start)&&p._ts&&E!==p){if(p.parent!==this)return this.render(i,s,o);if(p.render(p._ts>0?(f-p._start)*p._ts:(p._dirty?p.totalDuration():p._tDur)+(f-p._start)*p._ts,s,o),f!==this._time||!this._ts&&!d){E=0,g&&(u+=this._zTime=-ne);break}}p=g}else{p=this._last;for(var M=i<0?i:f;p;){if(g=p._prev,(p._act||M<=p._end)&&p._ts&&E!==p){if(p.parent!==this)return this.render(i,s,o);if(p.render(p._ts>0?(M-p._start)*p._ts:(p._dirty?p.totalDuration():p._tDur)+(M-p._start)*p._ts,s,o||Re&&(p._initted||p._startAt)),f!==this._time||!this._ts&&!d){E=0,g&&(u+=this._zTime=M?-ne:ne);break}}p=g}}if(E&&!s&&(this.pause(),E.render(f>=a?0:-ne)._zTime=f>=a?1:-1,this._ts))return this._start=v,No(this),this.render(i,s,o);this._onUpdate&&!s&&on(this,"onUpdate",!0),(u===l&&this._tTime>=this.totalDuration()||!u&&a)&&(v===this._start||Math.abs(x)!==Math.abs(this._ts))&&(this._lock||((i||!c)&&(u===l&&this._ts>0||!u&&this._ts<0)&&wi(this,1),!s&&!(i<0&&!a)&&(u||a||!l)&&(on(this,u===l&&i>=0?"onComplete":"onReverseComplete",!0),this._prom&&!(u<l&&this.timeScale()>0)&&this._prom())))}return this},e.add=function(i,s){var o=this;if(si(s)||(s=dn(this,s,i)),!(i instanceof bs)){if(Ue(i))return i.forEach(function(a){return o.add(a,s)}),this;if(Ae(i))return this.addLabel(i,s);if(de(i))i=ve.delayedCall(0,i);else return this}return this!==i?In(this,i,s):this},e.getChildren=function(i,s,o,a){i===void 0&&(i=!0),s===void 0&&(s=!0),o===void 0&&(o=!0),a===void 0&&(a=-gn);for(var l=[],c=this._first;c;)c._start>=a&&(c instanceof ve?s&&l.push(c):(o&&l.push(c),i&&l.push.apply(l,c.getChildren(!0,s,o)))),c=c._next;return l},e.getById=function(i){for(var s=this.getChildren(1,1,1),o=s.length;o--;)if(s[o].vars.id===i)return s[o]},e.remove=function(i){return Ae(i)?this.removeLabel(i):de(i)?this.killTweensOf(i):(i.parent===this&&Uo(this,i),i===this._recent&&(this._recent=this._last),$i(this))},e.totalTime=function(i,s){return arguments.length?(this._forcing=1,!this._dp&&this._ts&&(this._start=xe(rn.time-(this._ts>0?i/this._ts:(this.totalDuration()-i)/-this._ts))),r.prototype.totalTime.call(this,i,s),this._forcing=0,this):this._tTime},e.addLabel=function(i,s){return this.labels[i]=dn(this,s),this},e.removeLabel=function(i){return delete this.labels[i],this},e.addPause=function(i,s,o){var a=ve.delayedCall(0,s||Ms,o);return a.data="isPause",this._hasPause=1,In(this,a,dn(this,i))},e.removePause=function(i){var s=this._first;for(i=dn(this,i);s;)s._start===i&&s.data==="isPause"&&wi(s),s=s._next},e.killTweensOf=function(i,s,o){for(var a=this.getTweensOf(i,o),l=a.length;l--;)gi!==a[l]&&a[l].kill(i,s);return this},e.getTweensOf=function(i,s){for(var o=[],a=vn(i),l=this._first,c=si(s),u;l;)l instanceof ve?Wv(l._targets,a)&&(c?(!gi||l._initted&&l._ts)&&l.globalTime(0)<=s&&l.globalTime(l.totalDuration())>s:!s||l.isActive())&&o.push(l):(u=l.getTweensOf(a,s)).length&&o.push.apply(o,u),l=l._next;return o},e.tweenTo=function(i,s){s=s||{};var o=this,a=dn(o,i),l=s,c=l.startAt,u=l.onStart,h=l.onStartParams,f=l.immediateRender,p,g=ve.to(o,un({ease:s.ease||"none",lazy:!1,immediateRender:!1,time:a,overwrite:"auto",duration:s.duration||Math.abs((a-(c&&"time"in c?c.time:o._time))/o.timeScale())||ne,onStart:function(){if(o.pause(),!p){var m=s.duration||Math.abs((a-(c&&"time"in c?c.time:o._time))/o.timeScale());g._dur!==m&&Hr(g,m,0,1).render(g._time,!0,!0),p=1}u&&u.apply(g,h||[])}},s));return f?g.render(0):g},e.tweenFromTo=function(i,s,o){return this.tweenTo(s,un({startAt:{time:dn(this,i)}},o))},e.recent=function(){return this._recent},e.nextLabel=function(i){return i===void 0&&(i=this._time),Bu(this,dn(this,i))},e.previousLabel=function(i){return i===void 0&&(i=this._time),Bu(this,dn(this,i),1)},e.currentLabel=function(i){return arguments.length?this.seek(i,!0):this.previousLabel(this._time+ne)},e.shiftChildren=function(i,s,o){o===void 0&&(o=0);for(var a=this._first,l=this.labels,c;a;)a._start>=o&&(a._start+=i,a._end+=i),a=a._next;if(s)for(c in l)l[c]>=o&&(l[c]+=i);return $i(this)},e.invalidate=function(i){var s=this._first;for(this._lock=0;s;)s.invalidate(i),s=s._next;return r.prototype.invalidate.call(this,i)},e.clear=function(i){i===void 0&&(i=!0);for(var s=this._first,o;s;)o=s._next,this.remove(s),s=o;return this._dp&&(this._time=this._tTime=this._pTime=0),i&&(this.labels={}),$i(this)},e.totalDuration=function(i){var s=0,o=this,a=o._last,l=gn,c,u,h;if(arguments.length)return o.timeScale((o._repeat<0?o.duration():o.totalDuration())/(o.reversed()?-i:i));if(o._dirty){for(h=o.parent;a;)c=a._prev,a._dirty&&a.totalDuration(),u=a._start,u>l&&o._sort&&a._ts&&!o._lock?(o._lock=1,In(o,a,u-a._delay,1)._lock=0):l=u,u<0&&a._ts&&(s-=u,(!h&&!o._dp||h&&h.smoothChildTiming)&&(o._start+=u/o._ts,o._time-=u,o._tTime-=u),o.shiftChildren(-u,!1,-1/0),l=0),a._end>s&&a._ts&&(s=a._end),a=c;Hr(o,o===ce&&o._time>s?o._time:s,1,1),o._dirty=0}return o._tDur},t.updateRoot=function(i){if(ce._ts&&(Jh(ce,Eo(i,ce)),Kh=rn.frame),rn.frame>=Uu){Uu+=ln.autoSleep||120;var s=ce._first;if((!s||!s._ts)&&ln.autoSleep&&rn._listeners.length<2){for(;s&&!s._ts;)s=s._next;s||rn.sleep()}}},t}(bs);un(ze.prototype,{_lock:0,_hasPause:0,_forcing:0});var dx=function(t,e,n,i,s,o,a){var l=new qe(this._pt,t,e,0,1,Af,null,s),c=0,u=0,h,f,p,g,_,m,d,E;for(l.b=n,l.e=i,n+="",i+="",(d=~i.indexOf("random("))&&(i=Es(i)),o&&(E=[n,i],o(E,t,e),n=E[0],i=E[1]),f=n.match(ga)||[];h=ga.exec(i);)g=h[0],_=i.substring(c,h.index),p?p=(p+1)%5:_.substr(-5)==="rgba("&&(p=1),g!==f[u++]&&(m=parseFloat(f[u-1])||0,l._pt={_next:l._pt,p:_||u===1?_:",",s:m,c:g.charAt(1)==="="?Cr(m,g)-m:parseFloat(g)-m,m:p&&p<4?Math.round:0},c=ga.lastIndex);return l.c=c<i.length?i.substring(c,i.length):"",l.fp=a,(Wh.test(i)||d)&&(l.e=0),this._pt=l,l},lc=function(t,e,n,i,s,o,a,l,c,u){de(i)&&(i=i(s||0,t,o));var h=t[e],f=n!=="get"?n:de(h)?c?t[e.indexOf("set")||!de(t["get"+e.substr(3)])?e:"get"+e.substr(3)](c):t[e]():h,p=de(h)?c?vx:Tf:uc,g;if(Ae(i)&&(~i.indexOf("random(")&&(i=Es(i)),i.charAt(1)==="="&&(g=Cr(f,i)+(Ie(f)||0),(g||g===0)&&(i=g))),!u||f!==i||Cl)return!isNaN(f*i)&&i!==""?(g=new qe(this._pt,t,e,+f||0,i-(f||0),typeof h=="boolean"?yx:bf,0,p),c&&(g.fp=c),a&&g.modifier(a,this,t),this._pt=g):(!h&&!(e in t)&&rc(e,i),dx.call(this,t,e,f,i,p,l||ln.stringFilter,c))},px=function(t,e,n,i,s){if(de(t)&&(t=_s(t,s,e,n,i)),!Bn(t)||t.style&&t.nodeType||Ue(t)||Hh(t))return Ae(t)?_s(t,s,e,n,i):t;var o={},a;for(a in t)o[a]=_s(t[a],s,e,n,i);return o},Sf=function(t,e,n,i,s,o){var a,l,c,u;if(Qe[t]&&(a=new Qe[t]).init(s,a.rawVars?e[t]:px(e[t],i,s,o,n),n,i,o)!==!1&&(n._pt=l=new qe(n._pt,s,t,0,1,a.render,a,0,a.priority),n!==Tr))for(c=n._ptLookup[n._targets.indexOf(s)],u=a._props.length;u--;)c[a._props[u]]=l;return a},gi,Cl,cc=function r(t,e,n){var i=t.vars,s=i.ease,o=i.startAt,a=i.immediateRender,l=i.lazy,c=i.onUpdate,u=i.runBackwards,h=i.yoyoEase,f=i.keyframes,p=i.autoRevert,g=t._dur,_=t._startAt,m=t._targets,d=t.parent,E=d&&d.data==="nested"?d.vars.targets:m,x=t._overwrite==="auto"&&!tc,v=t.timeline,R,w,b,C,y,M,D,k,O,G,X,V,Y;if(v&&(!f||!s)&&(s="none"),t._ease=Ji(s,zr.ease),t._yEase=h?gf(Ji(h===!0?s:h,zr.ease)):0,h&&t._yoyo&&!t._repeat&&(h=t._yEase,t._yEase=t._ease,t._ease=h),t._from=!v&&!!i.runBackwards,!v||f&&!i.stagger){if(k=m[0]?Ki(m[0]).harness:0,V=k&&i[k.prop],R=Mo(i,sc),_&&(_._zTime<0&&_.progress(1),e<0&&u&&a&&!p?_.render(-1,!0):_.revert(u&&g?po:Hv),_._lazy=0),o){if(wi(t._startAt=ve.set(m,un({data:"isStart",overwrite:!1,parent:d,immediateRender:!0,lazy:!_&&We(l),startAt:null,delay:0,onUpdate:c&&function(){return on(t,"onUpdate")},stagger:0},o))),t._startAt._dp=0,t._startAt._sat=t,e<0&&(Re||!a&&!p)&&t._startAt.revert(po),a&&g&&e<=0&&n<=0){e&&(t._zTime=e);return}}else if(u&&g&&!_){if(e&&(a=!1),b=un({overwrite:!1,data:"isFromStart",lazy:a&&!_&&We(l),immediateRender:a,stagger:0,parent:d},R),V&&(b[k.prop]=V),wi(t._startAt=ve.set(m,b)),t._startAt._dp=0,t._startAt._sat=t,e<0&&(Re?t._startAt.revert(po):t._startAt.render(-1,!0)),t._zTime=e,!a)r(t._startAt,ne,ne);else if(!e)return}for(t._pt=t._ptCache=0,l=g&&We(l)||l&&!g,w=0;w<m.length;w++){if(y=m[w],D=y._gsap||ac(m)[w]._gsap,t._ptLookup[w]=G={},El[D.id]&&Ei.length&&So(),X=E===m?w:E.indexOf(y),k&&(O=new k).init(y,V||R,t,X,E)!==!1&&(t._pt=C=new qe(t._pt,y,O.name,0,1,O.render,O,0,O.priority),O._props.forEach(function(H){G[H]=C}),O.priority&&(M=1)),!k||V)for(b in R)Qe[b]&&(O=Sf(b,R,t,X,y,E))?O.priority&&(M=1):G[b]=C=lc.call(t,y,b,"get",R[b],X,E,0,i.stringFilter);t._op&&t._op[w]&&t.kill(y,t._op[w]),x&&t._pt&&(gi=t,ce.killTweensOf(y,G,t.globalTime(e)),Y=!t.parent,gi=0),t._pt&&l&&(El[D.id]=1)}M&&wf(t),t._onInit&&t._onInit(t)}t._onUpdate=c,t._initted=(!t._op||t._pt)&&!Y,f&&e<=0&&v.render(gn,!0,!0)},mx=function(t,e,n,i,s,o,a,l){var c=(t._pt&&t._ptCache||(t._ptCache={}))[e],u,h,f,p;if(!c)for(c=t._ptCache[e]=[],f=t._ptLookup,p=t._targets.length;p--;){if(u=f[p][e],u&&u.d&&u.d._pt)for(u=u.d._pt;u&&u.p!==e&&u.fp!==e;)u=u._next;if(!u)return Cl=1,t.vars[e]="+=0",cc(t,a),Cl=0,l?Ss(e+" not eligible for reset"):1;c.push(u)}for(p=c.length;p--;)h=c[p],u=h._pt||h,u.s=(i||i===0)&&!s?i:u.s+(i||0)+o*u.c,u.c=n-u.s,h.e&&(h.e=me(n)+Ie(h.e)),h.b&&(h.b=u.s+Ie(h.b))},_x=function(t,e){var n=t[0]?Ki(t[0]).harness:0,i=n&&n.aliases,s,o,a,l;if(!i)return e;s=kr({},e);for(o in i)if(o in s)for(l=i[o].split(","),a=l.length;a--;)s[l[a]]=s[o];return s},gx=function(t,e,n,i){var s=e.ease||i||"power1.inOut",o,a;if(Ue(e))a=n[t]||(n[t]=[]),e.forEach(function(l,c){return a.push({t:c/(e.length-1)*100,v:l,e:s})});else for(o in e)a=n[o]||(n[o]=[]),o==="ease"||a.push({t:parseFloat(t),v:e[o],e:s})},_s=function(t,e,n,i,s){return de(t)?t.call(e,n,i,s):Ae(t)&&~t.indexOf("random(")?Es(t):t},Mf=oc+"repeat,repeatDelay,yoyo,repeatRefresh,yoyoEase,autoRevert",Ef={};Xe(Mf+",id,stagger,delay,duration,paused,scrollTrigger",function(r){return Ef[r]=1});var ve=function(r){kh(t,r);function t(n,i,s,o){var a;typeof i=="number"&&(s.duration=i,i=s,s=null),a=r.call(this,o?i:ps(i))||this;var l=a.vars,c=l.duration,u=l.delay,h=l.immediateRender,f=l.stagger,p=l.overwrite,g=l.keyframes,_=l.defaults,m=l.scrollTrigger,d=l.yoyoEase,E=i.parent||ce,x=(Ue(n)||Hh(n)?si(n[0]):"length"in i)?[n]:vn(n),v,R,w,b,C,y,M,D;if(a._targets=x.length?ac(x):Ss("GSAP target "+n+" not found. https://gsap.com",!ln.nullTargetWarn)||[],a._ptLookup=[],a._overwrite=p,g||f||so(c)||so(u)){if(i=a.vars,v=a.timeline=new ze({data:"nested",defaults:_||{},targets:E&&E.data==="nested"?E.vars.targets:x}),v.kill(),v.parent=v._dp=Kn(a),v._start=0,f||so(c)||so(u)){if(b=x.length,M=f&&af(f),Bn(f))for(C in f)~Mf.indexOf(C)&&(D||(D={}),D[C]=f[C]);for(R=0;R<b;R++)w=Mo(i,Ef),w.stagger=0,d&&(w.yoyoEase=d),D&&kr(w,D),y=x[R],w.duration=+_s(c,Kn(a),R,y,x),w.delay=(+_s(u,Kn(a),R,y,x)||0)-a._delay,!f&&b===1&&w.delay&&(a._delay=u=w.delay,a._start+=u,w.delay=0),v.to(y,w,M?M(R,y,x):0),v._ease=Gt.none;v.duration()?c=u=0:a.timeline=0}else if(g){ps(un(v.vars.defaults,{ease:"none"})),v._ease=Ji(g.ease||i.ease||"none");var k=0,O,G,X;if(Ue(g))g.forEach(function(V){return v.to(x,V,">")}),v.duration();else{w={};for(C in g)C==="ease"||C==="easeEach"||gx(C,g[C],w,g.easeEach);for(C in w)for(O=w[C].sort(function(V,Y){return V.t-Y.t}),k=0,R=0;R<O.length;R++)G=O[R],X={ease:G.e,duration:(G.t-(R?O[R-1].t:0))/100*c},X[C]=G.v,v.to(x,X,k),k+=X.duration;v.duration()<c&&v.to({},{duration:c-v.duration()})}}c||a.duration(c=v.duration())}else a.timeline=0;return p===!0&&!tc&&(gi=Kn(a),ce.killTweensOf(x),gi=0),In(E,Kn(a),s),i.reversed&&a.reverse(),i.paused&&a.paused(!0),(h||!c&&!g&&a._start===xe(E._time)&&We(h)&&Zv(Kn(a))&&E.data!=="nested")&&(a._tTime=-ne,a.render(Math.max(0,-u)||0)),m&&nf(Kn(a),m),a}var e=t.prototype;return e.render=function(i,s,o){var a=this._time,l=this._tDur,c=this._dur,u=i<0,h=i>l-ne&&!u?l:i<ne?0:i,f,p,g,_,m,d,E,x,v;if(!c)$v(this,i,s,o);else if(h!==this._tTime||!i||o||!this._initted&&this._tTime||this._startAt&&this._zTime<0!==u||this._lazy){if(f=h,x=this.timeline,this._repeat){if(_=c+this._rDelay,this._repeat<-1&&u)return this.totalTime(_*100+i,s,o);if(f=xe(h%_),h===l?(g=this._repeat,f=c):(m=xe(h/_),g=~~m,g&&g===m?(f=c,g--):f>c&&(f=c)),d=this._yoyo&&g&1,d&&(v=this._yEase,f=c-f),m=Vr(this._tTime,_),f===a&&!o&&this._initted&&g===m)return this._tTime=h,this;g!==m&&(x&&this._yEase&&vf(x,d),this.vars.repeatRefresh&&!d&&!this._lock&&f!==_&&this._initted&&(this._lock=o=1,this.render(xe(_*g),!0).invalidate()._lock=0))}if(!this._initted){if(rf(this,u?i:f,o,s,h))return this._tTime=0,this;if(a!==this._time&&!(o&&this.vars.repeatRefresh&&g!==m))return this;if(c!==this._dur)return this.render(i,s,o)}if(this._tTime=h,this._time=f,!this._act&&this._ts&&(this._act=1,this._lazy=0),this.ratio=E=(v||this._ease)(f/c),this._from&&(this.ratio=E=1-E),f&&!a&&!s&&!g&&(on(this,"onStart"),this._tTime!==h))return this;for(p=this._pt;p;)p.r(E,p.d),p=p._next;x&&x.render(i<0?i:x._dur*x._ease(f/this._dur),s,o)||this._startAt&&(this._zTime=i),this._onUpdate&&!s&&(u&&Tl(this,i,s,o),on(this,"onUpdate")),this._repeat&&g!==m&&this.vars.onRepeat&&!s&&this.parent&&on(this,"onRepeat"),(h===this._tDur||!h)&&this._tTime===h&&(u&&!this._onUpdate&&Tl(this,i,!0,!0),(i||!c)&&(h===this._tDur&&this._ts>0||!h&&this._ts<0)&&wi(this,1),!s&&!(u&&!a)&&(h||a||d)&&(on(this,h===l?"onComplete":"onReverseComplete",!0),this._prom&&!(h<l&&this.timeScale()>0)&&this._prom()))}return this},e.targets=function(){return this._targets},e.invalidate=function(i){return(!i||!this.vars.runBackwards)&&(this._startAt=0),this._pt=this._op=this._onUpdate=this._lazy=this.ratio=0,this._ptLookup=[],this.timeline&&this.timeline.invalidate(i),r.prototype.invalidate.call(this,i)},e.resetTo=function(i,s,o,a,l){Ts||rn.wake(),this._ts||this.play();var c=Math.min(this._dur,(this._dp._time-this._start)*this._ts),u;return this._initted||cc(this,c),u=this._ease(c/this._dur),mx(this,i,s,o,a,u,c,l)?this.resetTo(i,s,o,a,1):(Oo(this,0),this.parent||tf(this._dp,this,"_first","_last",this._dp._sort?"_start":0),this.render(0))},e.kill=function(i,s){if(s===void 0&&(s="all"),!i&&(!s||s==="all"))return this._lazy=this._pt=0,this.parent?ls(this):this.scrollTrigger&&this.scrollTrigger.kill(!!Re),this;if(this.timeline){var o=this.timeline.totalDuration();return this.timeline.killTweensOf(i,s,gi&&gi.vars.overwrite!==!0)._first||ls(this),this.parent&&o!==this.timeline.totalDuration()&&Hr(this,this._dur*this.timeline._tDur/o,0,1),this}var a=this._targets,l=i?vn(i):a,c=this._ptLookup,u=this._pt,h,f,p,g,_,m,d;if((!s||s==="all")&&qv(a,l))return s==="all"&&(this._pt=0),ls(this);for(h=this._op=this._op||[],s!=="all"&&(Ae(s)&&(_={},Xe(s,function(E){return _[E]=1}),s=_),s=_x(a,s)),d=a.length;d--;)if(~l.indexOf(a[d])){f=c[d],s==="all"?(h[d]=s,g=f,p={}):(p=h[d]=h[d]||{},g=s);for(_ in g)m=f&&f[_],m&&((!("kill"in m.d)||m.d.kill(_)===!0)&&Uo(this,m,"_pt"),delete f[_]),p!=="all"&&(p[_]=1)}return this._initted&&!this._pt&&u&&ls(this),this},t.to=function(i,s){return new t(i,s,arguments[2])},t.from=function(i,s){return ms(1,arguments)},t.delayedCall=function(i,s,o,a){return new t(s,0,{immediateRender:!1,lazy:!1,overwrite:!1,delay:i,onComplete:s,onReverseComplete:s,onCompleteParams:o,onReverseCompleteParams:o,callbackScope:a})},t.fromTo=function(i,s,o){return ms(2,arguments)},t.set=function(i,s){return s.duration=0,s.repeatDelay||(s.repeat=0),new t(i,s)},t.killTweensOf=function(i,s,o){return ce.killTweensOf(i,s,o)},t}(bs);un(ve.prototype,{_targets:[],_lazy:0,_startAt:0,_op:0,_onInit:0});Xe("staggerTo,staggerFrom,staggerFromTo",function(r){ve[r]=function(){var t=new ze,e=Al.call(arguments,0);return e.splice(r==="staggerFromTo"?5:4,0,0),t[r].apply(t,e)}});var uc=function(t,e,n){return t[e]=n},Tf=function(t,e,n){return t[e](n)},vx=function(t,e,n,i){return t[e](i.fp,n)},xx=function(t,e,n){return t.setAttribute(e,n)},hc=function(t,e){return de(t[e])?Tf:ec(t[e])&&t.setAttribute?xx:uc},bf=function(t,e){return e.set(e.t,e.p,Math.round((e.s+e.c*t)*1e6)/1e6,e)},yx=function(t,e){return e.set(e.t,e.p,!!(e.s+e.c*t),e)},Af=function(t,e){var n=e._pt,i="";if(!t&&e.b)i=e.b;else if(t===1&&e.e)i=e.e;else{for(;n;)i=n.p+(n.m?n.m(n.s+n.c*t):Math.round((n.s+n.c*t)*1e4)/1e4)+i,n=n._next;i+=e.c}e.set(e.t,e.p,i,e)},fc=function(t,e){for(var n=e._pt;n;)n.r(t,n.d),n=n._next},Sx=function(t,e,n,i){for(var s=this._pt,o;s;)o=s._next,s.p===i&&s.modifier(t,e,n),s=o},Mx=function(t){for(var e=this._pt,n,i;e;)i=e._next,e.p===t&&!e.op||e.op===t?Uo(this,e,"_pt"):e.dep||(n=1),e=i;return!n},Ex=function(t,e,n,i){i.mSet(t,e,i.m.call(i.tween,n,i.mt),i)},wf=function(t){for(var e=t._pt,n,i,s,o;e;){for(n=e._next,i=s;i&&i.pr>e.pr;)i=i._next;(e._prev=i?i._prev:o)?e._prev._next=e:s=e,(e._next=i)?i._prev=e:o=e,e=n}t._pt=s},qe=function(){function r(e,n,i,s,o,a,l,c,u){this.t=n,this.s=s,this.c=o,this.p=i,this.r=a||bf,this.d=l||this,this.set=c||uc,this.pr=u||0,this._next=e,e&&(e._prev=this)}var t=r.prototype;return t.modifier=function(n,i,s){this.mSet=this.mSet||this.set,this.set=Ex,this.m=n,this.mt=s,this.tween=i},r}();Xe(oc+"parent,duration,ease,delay,overwrite,runBackwards,startAt,yoyo,immediateRender,repeat,repeatDelay,data,paused,reversed,lazy,callbackScope,stringFilter,id,yoyoEase,stagger,inherit,repeatRefresh,keyframes,autoRevert,scrollTrigger",function(r){return sc[r]=1});cn.TweenMax=cn.TweenLite=ve;cn.TimelineLite=cn.TimelineMax=ze;ce=new ze({sortChildren:!1,defaults:zr,autoRemoveChildren:!0,id:"root",smoothChildTiming:!0});ln.stringFilter=_f;var ji=[],_o={},Tx=[],ku=0,bx=0,Ma=function(t){return(_o[t]||Tx).map(function(e){return e()})},Pl=function(){var t=Date.now(),e=[];t-ku>2&&(Ma("matchMediaInit"),ji.forEach(function(n){var i=n.queries,s=n.conditions,o,a,l,c;for(a in i)o=Dn.matchMedia(i[a]).matches,o&&(l=1),o!==s[a]&&(s[a]=o,c=1);c&&(n.revert(),l&&e.push(n))}),Ma("matchMediaRevert"),e.forEach(function(n){return n.onMatch(n,function(i){return n.add(null,i)})}),ku=t,Ma("matchMedia"))},Rf=function(){function r(e,n){this.selector=n&&wl(n),this.data=[],this._r=[],this.isReverted=!1,this.id=bx++,e&&this.add(e)}var t=r.prototype;return t.add=function(n,i,s){de(n)&&(s=i,i=n,n=de);var o=this,a=function(){var c=le,u=o.selector,h;return c&&c!==o&&c.data.push(o),s&&(o.selector=wl(s)),le=o,h=i.apply(o,arguments),de(h)&&o._r.push(h),le=c,o.selector=u,o.isReverted=!1,h};return o.last=a,n===de?a(o,function(l){return o.add(null,l)}):n?o[n]=a:a},t.ignore=function(n){var i=le;le=null,n(this),le=i},t.getTweens=function(){var n=[];return this.data.forEach(function(i){return i instanceof r?n.push.apply(n,i.getTweens()):i instanceof ve&&!(i.parent&&i.parent.data==="nested")&&n.push(i)}),n},t.clear=function(){this._r.length=this.data.length=0},t.kill=function(n,i){var s=this;if(n?function(){for(var a=s.getTweens(),l=s.data.length,c;l--;)c=s.data[l],c.data==="isFlip"&&(c.revert(),c.getChildren(!0,!0,!1).forEach(function(u){return a.splice(a.indexOf(u),1)}));for(a.map(function(u){return{g:u._dur||u._delay||u._sat&&!u._sat.vars.immediateRender?u.globalTime(0):-1/0,t:u}}).sort(function(u,h){return h.g-u.g||-1/0}).forEach(function(u){return u.t.revert(n)}),l=s.data.length;l--;)c=s.data[l],c instanceof ze?c.data!=="nested"&&(c.scrollTrigger&&c.scrollTrigger.revert(),c.kill()):!(c instanceof ve)&&c.revert&&c.revert(n);s._r.forEach(function(u){return u(n,s)}),s.isReverted=!0}():this.data.forEach(function(a){return a.kill&&a.kill()}),this.clear(),i)for(var o=ji.length;o--;)ji[o].id===this.id&&ji.splice(o,1)},t.revert=function(n){this.kill(n||{})},r}(),Ax=function(){function r(e){this.contexts=[],this.scope=e,le&&le.data.push(this)}var t=r.prototype;return t.add=function(n,i,s){Bn(n)||(n={matches:n});var o=new Rf(0,s||this.scope),a=o.conditions={},l,c,u;le&&!o.selector&&(o.selector=le.selector),this.contexts.push(o),i=o.add("onMatch",i),o.queries=n;for(c in n)c==="all"?u=1:(l=Dn.matchMedia(n[c]),l&&(ji.indexOf(o)<0&&ji.push(o),(a[c]=l.matches)&&(u=1),l.addListener?l.addListener(Pl):l.addEventListener("change",Pl)));return u&&i(o,function(h){return o.add(null,h)}),this},t.revert=function(n){this.kill(n||{})},t.kill=function(n){this.contexts.forEach(function(i){return i.kill(n,!0)})},r}(),To={registerPlugin:function(){for(var t=arguments.length,e=new Array(t),n=0;n<t;n++)e[n]=arguments[n];e.forEach(function(i){return df(i)})},timeline:function(t){return new ze(t)},getTweensOf:function(t,e){return ce.getTweensOf(t,e)},getProperty:function(t,e,n,i){Ae(t)&&(t=vn(t)[0]);var s=Ki(t||{}).get,o=n?Qh:jh;return n==="native"&&(n=""),t&&(e?o((Qe[e]&&Qe[e].get||s)(t,e,n,i)):function(a,l,c){return o((Qe[a]&&Qe[a].get||s)(t,a,l,c))})},quickSetter:function(t,e,n){if(t=vn(t),t.length>1){var i=t.map(function(u){return Ke.quickSetter(u,e,n)}),s=i.length;return function(u){for(var h=s;h--;)i[h](u)}}t=t[0]||{};var o=Qe[e],a=Ki(t),l=a.harness&&(a.harness.aliases||{})[e]||e,c=o?function(u){var h=new o;Tr._pt=0,h.init(t,n?u+n:u,Tr,0,[t]),h.render(1,h),Tr._pt&&fc(1,Tr)}:a.set(t,l);return o?c:function(u){return c(t,l,n?u+n:u,a,1)}},quickTo:function(t,e,n){var i,s=Ke.to(t,un((i={},i[e]="+=0.1",i.paused=!0,i.stagger=0,i),n||{})),o=function(l,c,u){return s.resetTo(e,l,c,u)};return o.tween=s,o},isTweening:function(t){return ce.getTweensOf(t,!0).length>0},defaults:function(t){return t&&t.ease&&(t.ease=Ji(t.ease,zr.ease)),Nu(zr,t||{})},config:function(t){return Nu(ln,t||{})},registerEffect:function(t){var e=t.name,n=t.effect,i=t.plugins,s=t.defaults,o=t.extendTimeline;(i||"").split(",").forEach(function(a){return a&&!Qe[a]&&!cn[a]&&Ss(e+" effect requires "+a+" plugin.")}),va[e]=function(a,l,c){return n(vn(a),un(l||{},s),c)},o&&(ze.prototype[e]=function(a,l,c){return this.add(va[e](a,Bn(l)?l:(c=l)&&{},this),c)})},registerEase:function(t,e){Gt[t]=Ji(e)},parseEase:function(t,e){return arguments.length?Ji(t,e):Gt},getById:function(t){return ce.getById(t)},exportRoot:function(t,e){t===void 0&&(t={});var n=new ze(t),i,s;for(n.smoothChildTiming=We(t.smoothChildTiming),ce.remove(n),n._dp=0,n._time=n._tTime=ce._time,i=ce._first;i;)s=i._next,(e||!(!i._dur&&i instanceof ve&&i.vars.onComplete===i._targets[0]))&&In(n,i,i._start-i._delay),i=s;return In(ce,n,0),n},context:function(t,e){return t?new Rf(t,e):le},matchMedia:function(t){return new Ax(t)},matchMediaRefresh:function(){return ji.forEach(function(t){var e=t.conditions,n,i;for(i in e)e[i]&&(e[i]=!1,n=1);n&&t.revert()})||Pl()},addEventListener:function(t,e){var n=_o[t]||(_o[t]=[]);~n.indexOf(e)||n.push(e)},removeEventListener:function(t,e){var n=_o[t],i=n&&n.indexOf(e);i>=0&&n.splice(i,1)},utils:{wrap:rx,wrapYoyo:sx,distribute:af,random:cf,snap:lf,normalize:ix,getUnit:Ie,clamp:Qv,splitColor:pf,toArray:vn,selector:wl,mapRange:hf,pipe:ex,unitize:nx,interpolate:ox,shuffle:of},install:Yh,effects:va,ticker:rn,updateRoot:ze.updateRoot,plugins:Qe,globalTimeline:ce,core:{PropTween:qe,globals:Zh,Tween:ve,Timeline:ze,Animation:bs,getCache:Ki,_removeLinkedListItem:Uo,reverting:function(){return Re},context:function(t){return t&&le&&(le.data.push(t),t._ctx=le),le},suppressOverwrites:function(t){return tc=t}}};Xe("to,from,fromTo,delayedCall,set,killTweensOf",function(r){return To[r]=ve[r]});rn.add(ze.updateRoot);Tr=To.to({},{duration:0});var wx=function(t,e){for(var n=t._pt;n&&n.p!==e&&n.op!==e&&n.fp!==e;)n=n._next;return n},Rx=function(t,e){var n=t._targets,i,s,o;for(i in e)for(s=n.length;s--;)o=t._ptLookup[s][i],o&&(o=o.d)&&(o._pt&&(o=wx(o,i)),o&&o.modifier&&o.modifier(e[i],t,n[s],i))},Ea=function(t,e){return{name:t,rawVars:1,init:function(i,s,o){o._onInit=function(a){var l,c;if(Ae(s)&&(l={},Xe(s,function(u){return l[u]=1}),s=l),e){l={};for(c in s)l[c]=e(s[c]);s=l}Rx(a,s)}}}},Ke=To.registerPlugin({name:"attr",init:function(t,e,n,i,s){var o,a,l;this.tween=n;for(o in e)l=t.getAttribute(o)||"",a=this.add(t,"setAttribute",(l||0)+"",e[o],i,s,0,0,o),a.op=o,a.b=l,this._props.push(o)},render:function(t,e){for(var n=e._pt;n;)Re?n.set(n.t,n.p,n.b,n):n.r(t,n.d),n=n._next}},{name:"endArray",init:function(t,e){for(var n=e.length;n--;)this.add(t,n,t[n]||0,e[n],0,0,0,0,0,1)}},Ea("roundProps",Rl),Ea("modifiers"),Ea("snap",lf))||To;ve.version=ze.version=Ke.version="3.12.7";qh=1;nc()&&Gr();Gt.Power0;Gt.Power1;Gt.Power2;Gt.Power3;Gt.Power4;Gt.Linear;Gt.Quad;Gt.Cubic;Gt.Quart;Gt.Quint;Gt.Strong;Gt.Elastic;Gt.Back;Gt.SteppedEase;Gt.Bounce;Gt.Sine;Gt.Expo;Gt.Circ;/*!
 * CSSPlugin 3.12.7
 * https://gsap.com
 *
 ...
 * Club GSAP members, the agreement issued with that membership.
 * @author: Jack Doyle, jack@greensock.com
*/var Vu,vi,Pr,dc,Yi,Hu,pc,Cx=function(){return typeof window<"u"},oi={},Hi=180/Math.PI,Dr=Math.PI/180,yr=Math.atan2,Gu=1e8,mc=/([A-Z])/g,Px=/(left|right|width|margin|padding|x)/i,Dx=/[\s,\(]\S/,Nn={autoAlpha:"opacity,visibility",scale:"scaleX,scaleY",alpha:"opacity"},Dl=function(t,e){return e.set(e.t,e.p,Math.round((e.s+e.c*t)*1e4)/1e4+e.u,e)},Lx=function(t,e){return e.set(e.t,e.p,t===1?e.e:Math.round((e.s+e.c*t)*1e4)/1e4+e.u,e)},Ix=function(t,e){return e.set(e.t,e.p,t?Math.round((e.s+e.c*t)*1e4)/1e4+e.u:e.b,e)},Ux=function(t,e){var n=e.s+e.c*t;e.set(e.t,e.p,~~(n+(n<0?-.5:.5))+e.u,e)},Cf=function(t,e){return e.set(e.t,e.p,t?e.e:e.b,e)},Pf=function(t,e){return e.set(e.t,e.p,t!==1?e.b:e.e,e)},Nx=function(t,e,n){return t.style[e]=n},Ox=function(t,e,n){return t.style.setProperty(e,n)},Fx=function(t,e,n){return t._gsap[e]=n},Bx=function(t,e,n){return t._gsap.scaleX=t._gsap.scaleY=n},zx=function(t,e,n,i,s){var o=t._gsap;o.scaleX=o.scaleY=n,o.renderTransform(s,o)},kx=function(t,e,n,i,s){var o=t._gsap;o[e]=n,o.renderTransform(s,o)},he="transform",Ye=he+"Origin",Vx=function r(t,e){var n=this,i=this.target,s=i.style,o=i._gsap;if(t in oi&&s){if(this.tfm=this.tfm||{},t!=="transform")t=Nn[t]||t,~t.indexOf(",")?t.split(",").forEach(function(a){return n.tfm[a]=$n(i,a)}):this.tfm[t]=o.x?o[t]:$n(i,t),t===Ye&&(this.tfm.zOrigin=o.zOrigin);else return Nn.transform.split(",").forEach(function(a){return r.call(n,a,e)});if(this.props.indexOf(he)>=0)return;o.svg&&(this.svgo=i.getAttribute("data-svg-origin"),this.props.push(Ye,e,"")),t=he}(s||e)&&this.props.push(t,e,s[t])},Df=function(t){t.translate&&(t.removeProperty("translate"),t.removeProperty("scale"),t.removeProperty("rotate"))},Hx=function(){var t=this.props,e=this.target,n=e.style,i=e._gsap,s,o;for(s=0;s<t.length;s+=3)t[s+1]?t[s+1]===2?e[t[s]](t[s+2]):e[t[s]]=t[s+2]:t[s+2]?n[t[s]]=t[s+2]:n.removeProperty(t[s].substr(0,2)==="--"?t[s]:t[s].replace(mc,"-$1").toLowerCase());if(this.tfm){for(o in this.tfm)i[o]=this.tfm[o];i.svg&&(i.renderTransform(),e.setAttribute("data-svg-origin",this.svgo||"")),s=pc(),(!s||!s.isStart)&&!n[he]&&(Df(n),i.zOrigin&&n[Ye]&&(n[Ye]+=" "+i.zOrigin+"px",i.zOrigin=0,i.renderTransform()),i.uncache=1)}},Lf=function(t,e){var n={target:t,props:[],revert:Hx,save:Vx};return t._gsap||Ke.core.getCache(t),e&&t.style&&t.nodeType&&e.split(",").forEach(function(i){return n.save(i)}),n},If,Ll=function(t,e){var n=vi.createElementNS?vi.createElementNS((e||"http://www.w3.org/1999/xhtml").replace(/^https/,"http"),t):vi.createElement(t);return n&&n.style?n:vi.createElement(t)},Fn=function r(t,e,n){var i=getComputedStyle(t);return i[e]||i.getPropertyValue(e.replace(mc,"-$1").toLowerCase())||i.getPropertyValue(e)||!n&&r(t,Wr(e)||e,1)||""},Wu="O,Moz,ms,Ms,Webkit".split(","),Wr=function(t,e,n){var i=e||Yi,s=i.style,o=5;if(t in s&&!n)return t;for(t=t.charAt(0).toUpperCase()+t.substr(1);o--&&!(Wu[o]+t in s););return o<0?null:(o===3?"ms":o>=0?Wu[o]:"")+t},Il=function(){Cx()&&window.document&&(Vu=window,vi=Vu.document,Pr=vi.documentElement,Yi=Ll("div")||{style:{}},Ll("div"),he=Wr(he),Ye=he+"Origin",Yi.style.cssText="border-width:0;line-height:0;position:absolute;padding:0",If=!!Wr("perspective"),pc=Ke.core.reverting,dc=1)},Xu=function(t){var e=t.ownerSVGElement,n=Ll("svg",e&&e.getAttribute("xmlns")||"http://www.w3.org/2000/svg"),i=t.cloneNode(!0),s;i.style.display="block",n.appendChild(i),Pr.appendChild(n);try{s=i.getBBox()}catch{}return n.removeChild(i),Pr.removeChild(n),s},qu=function(t,e){for(var n=e.length;n--;)if(t.hasAttribute(e[n]))return t.getAttribute(e[n])},Uf=function(t){var e,n;try{e=t.getBBox()}catch{e=Xu(t),n=1}return e&&(e.width||e.height)||n||(e=Xu(t)),e&&!e.width&&!e.x&&!e.y?{x:+qu(t,["x","cx","x1"])||0,y:+qu(t,["y","cy","y1"])||0,width:0,height:0}:e},Nf=function(t){return!!(t.getCTM&&(!t.parentNode||t.ownerSVGElement)&&Uf(t))},nr=function(t,e){if(e){var n=t.style,i;e in oi&&e!==Ye&&(e=he),n.removeProperty?(i=e.substr(0,2),(i==="ms"||e.substr(0,6)==="webkit")&&(e="-"+e),n.removeProperty(i==="--"?e:e.replace(mc,"-$1").toLowerCase())):n.removeAttribute(e)}},xi=function(t,e,n,i,s,o){var a=new qe(t._pt,e,n,0,1,o?Pf:Cf);return t._pt=a,a.b=i,a.e=s,t._props.push(n),a},Yu={deg:1,rad:1,turn:1},Gx={grid:1,flex:1},Ri=function r(t,e,n,i){var s=parseFloat(n)||0,o=(n+"").trim().substr((s+"").length)||"px",a=Yi.style,l=Px.test(e),c=t.tagName.toLowerCase()==="svg",u=(c?"client":"offset")+(l?"Width":"Height"),h=100,f=i==="px",p=i==="%",g,_,m,d;if(i===o||!s||Yu[i]||Yu[o])return s;if(o!=="px"&&!f&&(s=r(t,e,n,"px")),d=t.getCTM&&Nf(t),(p||o==="%")&&(oi[e]||~e.indexOf("adius")))return g=d?t.getBBox()[l?"width":"height"]:t[u],me(p?s/g*h:s/100*g);if(a[l?"width":"height"]=h+(f?o:i),_=i!=="rem"&&~e.indexOf("adius")||i==="em"&&t.appendChild&&!c?t:t.parentNode,d&&(_=(t.ownerSVGElement||{}).parentNode),(!_||_===vi||!_.appendChild)&&(_=vi.body),m=_._gsap,m&&p&&m.width&&l&&m.time===rn.time&&!m.uncache)return me(s/m.width*h);if(p&&(e==="height"||e==="width")){var E=t.style[e];t.style[e]=h+i,g=t[u],E?t.style[e]=E:nr(t,e)}else(p||o==="%")&&!Gx[Fn(_,"display")]&&(a.position=Fn(t,"position")),_===t&&(a.position="static"),_.appendChild(Yi),g=Yi[u],_.removeChild(Yi),a.position="absolute";return l&&p&&(m=Ki(_),m.time=rn.time,m.width=_[u]),me(f?g*s/h:g&&s?h/g*s:0)},$n=function(t,e,n,i){var s;return dc||Il(),e in Nn&&e!=="transform"&&(e=Nn[e],~e.indexOf(",")&&(e=e.split(",")[0])),oi[e]&&e!=="transform"?(s=ws(t,i),s=e!=="transformOrigin"?s[e]:s.svg?s.origin:Ao(Fn(t,Ye))+" "+s.zOrigin+"px"):(s=t.style[e],(!s||s==="auto"||i||~(s+"").indexOf("calc("))&&(s=bo[e]&&bo[e](t,e,n)||Fn(t,e)||$h(t,e)||(e==="opacity"?1:0))),n&&!~(s+"").trim().indexOf(" ")?Ri(t,e,s,n)+n:s},Wx=function(t,e,n,i){if(!n||n==="none"){var s=Wr(e,t,1),o=s&&Fn(t,s,1);o&&o!==n?(e=s,n=o):e==="borderColor"&&(n=Fn(t,"borderTopColor"))}var a=new qe(this._pt,t.style,e,0,1,Af),l=0,c=0,u,h,f,p,g,_,m,d,E,x,v,R;if(a.b=n,a.e=i,n+="",i+="",i==="auto"&&(_=t.style[e],t.style[e]=i,i=Fn(t,e)||i,_?t.style[e]=_:nr(t,e)),u=[n,i],_f(u),n=u[0],i=u[1],f=n.match(Er)||[],R=i.match(Er)||[],R.length){for(;h=Er.exec(i);)m=h[0],E=i.substring(l,h.index),g?g=(g+1)%5:(E.substr(-5)==="rgba("||E.substr(-5)==="hsla(")&&(g=1),m!==(_=f[c++]||"")&&(p=parseFloat(_)||0,v=_.substr((p+"").length),m.charAt(1)==="="&&(m=Cr(p,m)+v),d=parseFloat(m),x=m.substr((d+"").length),l=Er.lastIndex-x.length,x||(x=x||ln.units[e]||v,l===i.length&&(i+=x,a.e+=x)),v!==x&&(p=Ri(t,e,_,x)||0),a._pt={_next:a._pt,p:E||c===1?E:",",s:p,c:d-p,m:g&&g<4||e==="zIndex"?Math.round:0});a.c=l<i.length?i.substring(l,i.length):""}else a.r=e==="display"&&i==="none"?Pf:Cf;return Wh.test(i)&&(a.e=0),this._pt=a,a},Zu={top:"0%",bottom:"100%",left:"0%",right:"100%",center:"50%"},Xx=function(t){var e=t.split(" "),n=e[0],i=e[1]||"50%";return(n==="top"||n==="bottom"||i==="left"||i==="right")&&(t=n,n=i,i=t),e[0]=Zu[n]||n,e[1]=Zu[i]||i,e.join(" ")},qx=function(t,e){if(e.tween&&e.tween._time===e.tween._dur){var n=e.t,i=n.style,s=e.u,o=n._gsap,a,l,c;if(s==="all"||s===!0)i.cssText="",l=1;else for(s=s.split(","),c=s.length;--c>-1;)a=s[c],oi[a]&&(l=1,a=a==="transformOrigin"?Ye:he),nr(n,a);l&&(nr(n,he),o&&(o.svg&&n.removeAttribute("transform"),i.scale=i.rotate=i.translate="none",ws(n,1),o.uncache=1,Df(i)))}},bo={clearProps:function(t,e,n,i,s){if(s.data!=="isFromStart"){var o=t._pt=new qe(t._pt,e,n,0,0,qx);return o.u=i,o.pr=-10,o.tween=s,t._props.push(n),1}}},As=[1,0,0,1,0,0],Of={},Ff=function(t){return t==="matrix(1, 0, 0, 1, 0, 0)"||t==="none"||!t},Ku=function(t){var e=Fn(t,he);return Ff(e)?As:e.substr(7).match(Gh).map(me)},_c=function(t,e){var n=t._gsap||Ki(t),i=t.style,s=Ku(t),o,a,l,c;return n.svg&&t.getAttribute("transform")?(l=t.transform.baseVal.consolidate().matrix,s=[l.a,l.b,l.c,l.d,l.e,l.f],s.join(",")==="1,0,0,1,0,0"?As:s):(s===As&&!t.offsetParent&&t!==Pr&&!n.svg&&(l=i.display,i.display="block",o=t.parentNode,(!o||!t.offsetParent&&!t.getBoundingClientRect().width)&&(c=1,a=t.nextElementSibling,Pr.appendChild(t)),s=Ku(t),l?i.display=l:nr(t,"display"),c&&(a?o.insertBefore(t,a):o?o.appendChild(t):Pr.removeChild(t))),e&&s.length>6?[s[0],s[1],s[4],s[5],s[12],s[13]]:s)},Ul=function(t,e,n,i,s,o){var a=t._gsap,l=s||_c(t,!0),c=a.xOrigin||0,u=a.yOrigin||0,h=a.xOffset||0,f=a.yOffset||0,p=l[0],g=l[1],_=l[2],m=l[3],d=l[4],E=l[5],x=e.split(" "),v=parseFloat(x[0])||0,R=parseFloat(x[1])||0,w,b,C,y;n?l!==As&&(b=p*m-g*_)&&(C=v*(m/b)+R*(-_/b)+(_*E-m*d)/b,y=v*(-g/b)+R*(p/b)-(p*E-g*d)/b,v=C,R=y):(w=Uf(t),v=w.x+(~x[0].indexOf("%")?v/100*w.width:v),R=w.y+(~(x[1]||x[0]).indexOf("%")?R/100*w.height:R)),i||i!==!1&&a.smooth?(d=v-c,E=R-u,a.xOffset=h+(d*p+E*_)-d,a.yOffset=f+(d*g+E*m)-E):a.xOffset=a.yOffset=0,a.xOrigin=v,a.yOrigin=R,a.smooth=!!i,a.origin=e,a.originIsAbsolute=!!n,t.style[Ye]="0px 0px",o&&(xi(o,a,"xOrigin",c,v),xi(o,a,"yOrigin",u,R),xi(o,a,"xOffset",h,a.xOffset),xi(o,a,"yOffset",f,a.yOffset)),t.setAttribute("data-svg-origin",v+" "+R)},ws=function(t,e){var n=t._gsap||new yf(t);if("x"in n&&!e&&!n.uncache)return n;var i=t.style,s=n.scaleX<0,o="px",a="deg",l=getComputedStyle(t),c=Fn(t,Ye)||"0",u,h,f,p,g,_,m,d,E,x,v,R,w,b,C,y,M,D,k,O,G,X,V,Y,H,rt,lt,mt,Ct,Xt,q,Q;return u=h=f=_=m=d=E=x=v=0,p=g=1,n.svg=!!(t.getCTM&&Nf(t)),l.translate&&((l.translate!=="none"||l.scale!=="none"||l.rotate!=="none")&&(i[he]=(l.translate!=="none"?"translate3d("+(l.translate+" 0 0").split(" ").slice(0,3).join(", ")+") ":"")+(l.rotate!=="none"?"rotate("+l.rotate+") ":"")+(l.scale!=="none"?"scale("+l.scale.split(" ").join(",")+") ":"")+(l[he]!=="none"?l[he]:"")),i.scale=i.rotate=i.translate="none"),b=_c(t,n.svg),n.svg&&(n.uncache?(H=t.getBBox(),c=n.xOrigin-H.x+"px "+(n.yOrigin-H.y)+"px",Y=""):Y=!e&&t.getAttribute("data-svg-origin"),Ul(t,Y||c,!!Y||n.originIsAbsolute,n.smooth!==!1,b)),R=n.xOrigin||0,w=n.yOrigin||0,b!==As&&(D=b[0],k=b[1],O=b[2],G=b[3],u=X=b[4],h=V=b[5],b.length===6?(p=Math.sqrt(D*D+k*k),g=Math.sqrt(G*G+O*O),_=D||k?yr(k,D)*Hi:0,E=O||G?yr(O,G)*Hi+_:0,E&&(g*=Math.abs(Math.cos(E*Dr))),n.svg&&(u-=R-(R*D+w*O),h-=w-(R*k+w*G))):(Q=b[6],Xt=b[7],lt=b[8],mt=b[9],Ct=b[10],q=b[11],u=b[12],h=b[13],f=b[14],C=yr(Q,Ct),m=C*Hi,C&&(y=Math.cos(-C),M=Math.sin(-C),Y=X*y+lt*M,H=V*y+mt*M,rt=Q*y+Ct*M,lt=X*-M+lt*y,mt=V*-M+mt*y,Ct=Q*-M+Ct*y,q=Xt*-M+q*y,X=Y,V=H,Q=rt),C=yr(-O,Ct),d=C*Hi,C&&(y=Math.cos(-C),M=Math.sin(-C),Y=D*y-lt*M,H=k*y-mt*M,rt=O*y-Ct*M,q=G*M+q*y,D=Y,k=H,O=rt),C=yr(k,D),_=C*Hi,C&&(y=Math.cos(C),M=Math.sin(C),Y=D*y+k*M,H=X*y+V*M,k=k*y-D*M,V=V*y-X*M,D=Y,X=H),m&&Math.abs(m)+Math.abs(_)>359.9&&(m=_=0,d=180-d),p=me(Math.sqrt(D*D+k*k+O*O)),g=me(Math.sqrt(V*V+Q*Q)),C=yr(X,V),E=Math.abs(C)>2e-4?C*Hi:0,v=q?1/(q<0?-q:q):0),n.svg&&(Y=t.getAttribute("transform"),n.forceCSS=t.setAttribute("transform","")||!Ff(Fn(t,he)),Y&&t.setAttribute("transform",Y))),Math.abs(E)>90&&Math.abs(E)<270&&(s?(p*=-1,E+=_<=0?180:-180,_+=_<=0?180:-180):(g*=-1,E+=E<=0?180:-180)),e=e||n.uncache,n.x=u-((n.xPercent=u&&(!e&&n.xPercent||(Math.round(t.offsetWidth/2)===Math.round(-u)?-50:0)))?t.offsetWidth*n.xPercent/100:0)+o,n.y=h-((n.yPercent=h&&(!e&&n.yPercent||(Math.round(t.offsetHeight/2)===Math.round(-h)?-50:0)))?t.offsetHeight*n.yPercent/100:0)+o,n.z=f+o,n.scaleX=me(p),n.scaleY=me(g),n.rotation=me(_)+a,n.rotationX=me(m)+a,n.rotationY=me(d)+a,n.skewX=E+a,n.skewY=x+a,n.transformPerspective=v+o,(n.zOrigin=parseFloat(c.split(" ")[2])||!e&&n.zOrigin||0)&&(i[Ye]=Ao(c)),n.xOffset=n.yOffset=0,n.force3D=ln.force3D,n.renderTransform=n.svg?Zx:If?Bf:Yx,n.uncache=0,n},Ao=function(t){return(t=t.split(" "))[0]+" "+t[1]},Ta=function(t,e,n){var i=Ie(e);return me(parseFloat(e)+parseFloat(Ri(t,"x",n+"px",i)))+i},Yx=function(t,e){e.z="0px",e.rotationY=e.rotationX="0deg",e.force3D=0,Bf(t,e)},Bi="0deg",ss="0px",zi=") ",Bf=function(t,e){var n=e||this,i=n.xPercent,s=n.yPercent,o=n.x,a=n.y,l=n.z,c=n.rotation,u=n.rotationY,h=n.rotationX,f=n.skewX,p=n.skewY,g=n.scaleX,_=n.scaleY,m=n.transformPerspective,d=n.force3D,E=n.target,x=n.zOrigin,v="",R=d==="auto"&&t&&t!==1||d===!0;if(x&&(h!==Bi||u!==Bi)){var w=parseFloat(u)*Dr,b=Math.sin(w),C=Math.cos(w),y;w=parseFloat(h)*Dr,y=Math.cos(w),o=Ta(E,o,b*y*-x),a=Ta(E,a,-Math.sin(w)*-x),l=Ta(E,l,C*y*-x+x)}m!==ss&&(v+="perspective("+m+zi),(i||s)&&(v+="translate("+i+"%, "+s+"%) "),(R||o!==ss||a!==ss||l!==ss)&&(v+=l!==ss||R?"translate3d("+o+", "+a+", "+l+") ":"translate("+o+", "+a+zi),c!==Bi&&(v+="rotate("+c+zi),u!==Bi&&(v+="rotateY("+u+zi),h!==Bi&&(v+="rotateX("+h+zi),(f!==Bi||p!==Bi)&&(v+="skew("+f+", "+p+zi),(g!==1||_!==1)&&(v+="scale("+g+", "+_+zi),E.style[he]=v||"translate(0, 0)"},Zx=function(t,e){var n=e||this,i=n.xPercent,s=n.yPercent,o=n.x,a=n.y,l=n.rotation,c=n.skewX,u=n.skewY,h=n.scaleX,f=n.scaleY,p=n.target,g=n.xOrigin,_=n.yOrigin,m=n.xOffset,d=n.yOffset,E=n.forceCSS,x=parseFloat(o),v=parseFloat(a),R,w,b,C,y;l=parseFloat(l),c=parseFloat(c),u=parseFloat(u),u&&(u=parseFloat(u),c+=u,l+=u),l||c?(l*=Dr,c*=Dr,R=Math.cos(l)*h,w=Math.sin(l)*h,b=Math.sin(l-c)*-f,C=Math.cos(l-c)*f,c&&(u*=Dr,y=Math.tan(c-u),y=Math.sqrt(1+y*y),b*=y,C*=y,u&&(y=Math.tan(u),y=Math.sqrt(1+y*y),R*=y,w*=y)),R=me(R),w=me(w),b=me(b),C=me(C)):(R=h,C=f,w=b=0),(x&&!~(o+"").indexOf("px")||v&&!~(a+"").indexOf("px"))&&(x=Ri(p,"x",o,"px"),v=Ri(p,"y",a,"px")),(g||_||m||d)&&(x=me(x+g-(g*R+_*b)+m),v=me(v+_-(g*w+_*C)+d)),(i||s)&&(y=p.getBBox(),x=me(x+i/100*y.width),v=me(v+s/100*y.height)),y="matrix("+R+","+w+","+b+","+C+","+x+","+v+")",p.setAttribute("transform",y),E&&(p.style[he]=y)},Kx=function(t,e,n,i,s){var o=360,a=Ae(s),l=parseFloat(s)*(a&&~s.indexOf("rad")?Hi:1),c=l-i,u=i+c+"deg",h,f;return a&&(h=s.split("_")[1],h==="short"&&(c%=o,c!==c%(o/2)&&(c+=c<0?o:-o)),h==="cw"&&c<0?c=(c+o*Gu)%o-~~(c/o)*o:h==="ccw"&&c>0&&(c=(c-o*Gu)%o-~~(c/o)*o)),t._pt=f=new qe(t._pt,e,n,i,c,Lx),f.e=u,f.u="deg",t._props.push(n),f},$u=function(t,e){for(var n in e)t[n]=e[n];return t},$x=function(t,e,n){var i=$u({},n._gsap),s="perspective,force3D,transformOrigin,svgOrigin",o=n.style,a,l,c,u,h,f,p,g;i.svg?(c=n.getAttribute("transform"),n.setAttribute("transform",""),o[he]=e,a=ws(n,1),nr(n,he),n.setAttribute("transform",c)):(c=getComputedStyle(n)[he],o[he]=e,a=ws(n,1),o[he]=c);for(l in oi)c=i[l],u=a[l],c!==u&&s.indexOf(l)<0&&(p=Ie(c),g=Ie(u),h=p!==g?Ri(n,l,c,g):parseFloat(c),f=parseFloat(u),t._pt=new qe(t._pt,a,l,h,f-h,Dl),t._pt.u=g||0,t._props.push(l));$u(a,i)};Xe("padding,margin,Width,Radius",function(r,t){var e="Top",n="Right",i="Bottom",s="Left",o=(t<3?[e,n,i,s]:[e+s,e+n,i+n,i+s]).map(function(a){return t<2?r+a:"border"+a+r});bo[t>1?"border"+r:r]=function(a,l,c,u,h){var f,p;if(arguments.length<4)return f=o.map(function(g){return $n(a,g,c)}),p=f.join(" "),p.split(f[0]).length===5?f[0]:p;f=(u+"").split(" "),p={},o.forEach(function(g,_){return p[g]=f[_]=f[_]||f[(_-1)/2|0]}),a.init(l,p,h)}});var zf={name:"css",register:Il,targetTest:function(t){return t.style&&t.nodeType},init:function(t,e,n,i,s){var o=this._props,a=t.style,l=n.vars.startAt,c,u,h,f,p,g,_,m,d,E,x,v,R,w,b,C;dc||Il(),this.styles=this.styles||Lf(t),C=this.styles.props,this.tween=n;for(_ in e)if(_!=="autoRound"&&(u=e[_],!(Qe[_]&&Sf(_,e,n,i,t,s)))){if(p=typeof u,g=bo[_],p==="function"&&(u=u.call(n,i,t,s),p=typeof u),p==="string"&&~u.indexOf("random(")&&(u=Es(u)),g)g(this,t,_,u,n)&&(b=1);else if(_.substr(0,2)==="--")c=(getComputedStyle(t).getPropertyValue(_)+"").trim(),u+="",Ti.lastIndex=0,Ti.test(c)||(m=Ie(c),d=Ie(u)),d?m!==d&&(c=Ri(t,_,c,d)+d):m&&(u+=m),this.add(a,"setProperty",c,u,i,s,0,0,_),o.push(_),C.push(_,0,a[_]);else if(p!=="undefined"){if(l&&_ in l?(c=typeof l[_]=="function"?l[_].call(n,i,t,s):l[_],Ae(c)&&~c.indexOf("random(")&&(c=Es(c)),Ie(c+"")||c==="auto"||(c+=ln.units[_]||Ie($n(t,_))||""),(c+"").charAt(1)==="="&&(c=$n(t,_))):c=$n(t,_),f=parseFloat(c),E=p==="string"&&u.charAt(1)==="="&&u.substr(0,2),E&&(u=u.substr(2)),h=parseFloat(u),_ in Nn&&(_==="autoAlpha"&&(f===1&&$n(t,"visibility")==="hidden"&&h&&(f=0),C.push("visibility",0,a.visibility),xi(this,a,"visibility",f?"inherit":"hidden",h?"inherit":"hidden",!h)),_!=="scale"&&_!=="transform"&&(_=Nn[_],~_.indexOf(",")&&(_=_.split(",")[0]))),x=_ in oi,x){if(this.styles.save(_),v||(R=t._gsap,R.renderTransform&&!e.parseTransform||ws(t,e.parseTransform),w=e.smoothOrigin!==!1&&R.smooth,v=this._pt=new qe(this._pt,a,he,0,1,R.renderTransform,R,0,-1),v.dep=1),_==="scale")this._pt=new qe(this._pt,R,"scaleY",R.scaleY,(E?Cr(R.scaleY,E+h):h)-R.scaleY||0,Dl),this._pt.u=0,o.push("scaleY",_),_+="X";else if(_==="transformOrigin"){C.push(Ye,0,a[Ye]),u=Xx(u),R.svg?Ul(t,u,0,w,0,this):(d=parseFloat(u.split(" ")[2])||0,d!==R.zOrigin&&xi(this,R,"zOrigin",R.zOrigin,d),xi(this,a,_,Ao(c),Ao(u)));continue}else if(_==="svgOrigin"){Ul(t,u,1,w,0,this);continue}else if(_ in Of){Kx(this,R,_,f,E?Cr(f,E+u):u);continue}else if(_==="smoothOrigin"){xi(this,R,"smooth",R.smooth,u);continue}else if(_==="force3D"){R[_]=u;continue}else if(_==="transform"){$x(this,u,t);continue}}else _ in a||(_=Wr(_)||_);if(x||(h||h===0)&&(f||f===0)&&!Dx.test(u)&&_ in a)m=(c+"").substr((f+"").length),h||(h=0),d=Ie(u)||(_ in ln.units?ln.units[_]:m),m!==d&&(f=Ri(t,_,c,d)),this._pt=new qe(this._pt,x?R:a,_,f,(E?Cr(f,E+h):h)-f,!x&&(d==="px"||_==="zIndex")&&e.autoRound!==!1?Ux:Dl),this._pt.u=d||0,m!==d&&d!=="%"&&(this._pt.b=c,this._pt.r=Ix);else if(_ in a)Wx.call(this,t,_,c,E?E+u:u);else if(_ in t)this.add(t,_,c||t[_],E?E+u:u,i,s);else if(_!=="parseTransform"){rc(_,u);continue}x||(_ in a?C.push(_,0,a[_]):typeof t[_]=="function"?C.push(_,2,t[_]()):C.push(_,1,c||t[_])),o.push(_)}}b&&wf(this)},render:function(t,e){if(e.tween._time||!pc())for(var n=e._pt;n;)n.r(t,n.d),n=n._next;else e.styles.revert()},get:$n,aliases:Nn,getSetter:function(t,e,n){var i=Nn[e];return i&&i.indexOf(",")<0&&(e=i),e in oi&&e!==Ye&&(t._gsap.x||$n(t,"x"))?n&&Hu===n?e==="scale"?Bx:Fx:(Hu=n||{})&&(e==="scale"?zx:kx):t.style&&!ec(t.style[e])?Nx:~e.indexOf("-")?Ox:hc(t,e)},core:{_removeProperty:nr,_getMatrix:_c}};Ke.utils.checkPrefix=Wr;Ke.core.getStyleSaver=Lf;(function(r,t,e,n){var i=Xe(r+","+t+","+e,function(s){oi[s]=1});Xe(t,function(s){ln.units[s]="deg",Of[s]=1}),Nn[i[13]]=r+","+t,Xe(n,function(s){var o=s.split(":");Nn[o[1]]=i[o[0]]})})("x,y,z,scale,scaleX,scaleY,xPercent,yPercent","rotation,rotationX,rotationY,skewX,skewY","transform,transformOrigin,svgOrigin,force3D,smoothOrigin,transformPerspective","0:translateX,1:translateY,2:translateZ,8:rotate,8:rotationZ,8:rotateZ,9:rotateX,10:rotateY");Xe("x,y,z,top,right,bottom,left,width,height,fontSize,padding,margin,perspective",function(r){ln.units[r]="px"});Ke.registerPlugin(zf);var Se=Ke.registerPlugin(zf)||Ke;Se.core.Tween;function gc(r,t={}){if(!r)return Jx("no mesh object provided");this.item=r,this.enabled=!1,this.selected=!1,this.sequenceDefault=t&&t.animateDefault?t.animateDefault:null,this.sequenceSelected=t&&t.animateSelect?t.animateSelect:null,this.sequenceClicked=t&&t.animateClicked?t.animateClicked:null,this.rotationSpeed=t&&t.rotationSpeed?t.rotationSpeed:.01,this.rotateX=t&&t.rotateX?t.rotateX:!1,this.rotateY=t&&t.rotateX?t.rotateY:!1,this.rotateZ=t&&t.rotateX?t.rotateZ:!1}gc.prototype.animateDefault=function(r=0){this.enabled&&(typeof this.sequenceDefault=="function"?this.sequenceDefault(r,this):(this.item.rotation.x=this.rotateX?this.rotationSpeed*r:this.item.rotation.x,this.item.rotation.y=this.rotateY?this.rotationSpeed*r:this.item.rotation.y,this.item.rotation.z=this.rotateZ?this.rotationSpeed*r:this.item.rotation.z),this.selected=!1)};gc.prototype.animateSelected=function(r=0){if(this.enabled){if(typeof this.sequenceSelected=="function")this.sequenceSelected(r,this);else{const t=this.rotationSpeed*.25;this.item.rotation.x=this.rotateX?t*r:this.item.rotation.x,this.item.rotation.y=this.rotateY?t*r:this.item.rotation.y,this.item.rotation.z=this.rotateZ?t*r:this.item.rotation.z}this.selected=!0}};function Jx(r){return"menuItem error: "+r}let ni=!1,Nl=!1,Lr=!1,pn,mn,Ze,ba,we=null,ti=0;const Ju=new Dv,Aa=new pt;function Te(r=null,t=null,e=null){this.scene=r,this.camera=t,this.itemTray=[],this.itemTrayAction=[],this.itemSelected=0,this.menuRotate=!0,this.enabled=!0,this.opened=!1,this.itemGroup=new nn,this.itemCount=0,this.init(e),this.reload()}Te.prototype.OPEN_NOTRANSITION=0;Te.prototype.OPEN_GROW=1;Te.prototype.OPEN_TRANSPARENCY=2;Te.prototype.init=function(r){ti=0,we=null,pn=mn=null,this.defaultSpeed=.1,this.cameraDistance=1,this.gapBetweenItems={x:1,y:0,z:0},this.menuOffsetItems={x:0,y:0,z:0},r&&typeof r.gapBetweenItems=="object"&&(this.gapBetweenItems.x=typeof r.gapBetweenItems.x=="number"?r.gapBetweenItems.x:this.gapBetweenItems.x,this.gapBetweenItems.y=typeof r.gapBetweenItems.y=="number"?r.gapBetweenItems.y:this.gapBetweenItems.y,this.gapBetweenItems.z=typeof r.gapBetweenItems.z=="number"?r.gapBetweenItems.z:this.gapBetweenItems.z),r&&typeof r.menuOffsetItems=="object"&&(this.menuOffsetItems.x=typeof r.menuOffsetItems.x=="number"?r.menuOffsetItems.x:this.menuOffsetItems.x,this.menuOffsetItems.y=typeof r.menuOffsetItems.y=="number"?r.menuOffsetItems.y:this.menuOffsetItems.y,this.menuOffsetItems.z=typeof r.menuOffsetItems.z=="number"?r.menuOffsetItems.z:this.menuOffsetItems.z),this.selectBehavior="grow",this.resizeScale=r&&typeof r.resizeScale=="number"?r.resizeScale:.5,this.resizeSpeed=r&&typeof r.resizeSpeed=="number"?r.resizeSpeed:2,this.closeTime=r&&typeof r.closeTime=="number"?r.closeTime:.5,this.openTime=r&&typeof r.openTime=="number"?r.openTime:.5,this.shuffleSpeed=r&&typeof r.shuffleSpeed=="number"?r.shuffleSpeed:2,this.revolvingMenu=r&&r.revolvingMenu?r.revolvingMenu:!0,this.openBehavior=r&&r.openBehavior&&typeof r.openBehavior=="number"?r.openBehavior:this.OPEN_NOTRANSITION,this.prevKey=r&&r.prevKey&&typeof r.prevKey=="string"?r.prevKey:"ArrowLeft",this.nextKey=r&&r.nextKey&&typeof r.nextKey=="string"?r.nextKey:"ArrowRight",this.selectKey=r&&r.selectKey&&typeof r.selectKey=="string"?r.selectKey:"Enter"};Te.prototype.add=function(r,t=null,e){const n=e||{};n.rotationSpeed=this.defaultSpeed;const i=new gc(r,n),s=new jx(i,t,this.itemTray.length);ti==0&&(Ze=s,ba=s,s.selected=!0,we=s),s.prev=ba,s.next=Ze,s.prev.next=s,s.next.prev=s,ba=s,r.name=ti;function o(a,l){if(a&&(a.itemTag=ti),Object.hasOwn(a,"children")&&a.children.length>0)for(let c=0;c<a.children.length;c++)o(a.children[c])}o(r),ti++,r.position.set(0,0,0),s.properties.scale={x:s.node.item.scale.x,y:s.node.item.scale.y,z:s.node.item.scale.z},s.node.item.material&&Object.hasOwn(s.node.item.material,"transparent")&&(s.properties.transparent=s.node.item.material.transparent,s.properties.opacity=s.node.item.material.opacity),this.itemTray.push(s),this.itemTrayAction.push(t),this.itemGroup.add(r),this.itemCount++,this.repositionNodes()};Te.prototype.repositionNodes=function(){this.itemGroup.position.set(0,0,0);let r={x:0-this.gapBetweenItems.x,y:0-this.gapBetweenItems.y,z:0-this.gapBetweenItems.z},t;const e=ti,n=e%2==0;let i=0;t=Math.floor(e/2);let s=Ze;do{switch(r={x:r.x+this.gapBetweenItems.x,y:r.y+this.gapBetweenItems.y,z:r.z+this.gapBetweenItems.z},s.node.item.position.set(r.x,r.y,r.z),r.x=s.node.item.position.x,r.y=s.node.item.position.y,r.z=s.node.item.position.z,(ti===2&&s.id===1||s.id===t+1)&&(pn=s),s.id===t&&(i=n?0:1,r.x=-(s.node.item.position.x+this.gapBetweenItems.x*i),r.y=-(s.node.item.position.y+this.gapBetweenItems.y*i),r.z=-(s.node.item.position.z+this.gapBetweenItems.z*i),mn=s),this.openBehavior){case this.OPEN_GROW:s.node.item.scale.set({x:0,y:0,z:0});break}s=s.next}while(s.id!=Ze.id);return this.itemGroup.position.x+=this.menuOffsetItems.x,this.itemGroup.position.y+=this.menuOffsetItems.y,this.itemGroup.position.z+=this.menuOffsetItems.z,r};Te.prototype.reload=function(){this.itemTray.length>0&&this.itemTray.forEach(r=>{r.node.rotationSpeed=this.defaultSpeed}),this.scene&&this.scene.add(this.itemGroup),this.camera&&this.camera.position.set(0,0,this.cameraDistance),this.registerEvents()};Te.prototype.animate=function(r=null){if(!r)return;let t=Ze,e=t;do{if(!e)break;const n=e.node;e.selected?n.animateSelected(r):n.animateDefault(r),e=e.next}while(e.id!=t.id)};Te.prototype.moveToNext=function(){if(!this.opened||ti<=1||Lr||!this.revolvingMenu&&this.itemSelected>=this.itemTray.length-1)return ni=!1;let r=Ze,t=r;Lr=!0;do{const e=t.node;t==pn&&(pn.node.item.position.set(pn.prev.node.item.position.x+this.gapBetweenItems.x,pn.prev.node.item.position.y+this.gapBetweenItems.y,pn.prev.node.item.position.z+this.gapBetweenItems.z),mn=pn),Se.to(e.item.position,{x:e.item.position.x-this.gapBetweenItems.x,y:e.item.position.y-this.gapBetweenItems.y,z:e.item.position.z-this.gapBetweenItems.z,duration:this.shuffleSpeed*.1,onComplete:()=>{ni=!1}}),t.selected&&(we=t.next,t.selected=!1),t=t.next}while(t.id!=Ze.id);pn=pn.next,we.selected=!0,this.itemSelected=we.id,Lr=!1};Te.prototype.moveToPrev=function(){if(!this.opened||ti<=1||Lr||!this.revolvingMenu&&this.itemSelected<=0)return ni=!1;let r=Ze,t=r;Lr=!0;do{const e=t.node;t==mn&&(mn.node.item.position.set(mn.next.node.item.position.x-this.gapBetweenItems.x,mn.next.node.item.position.y-this.gapBetweenItems.y,mn.next.node.item.position.z-this.gapBetweenItems.z),pn=mn),Se.to(e.item.position,{x:e.item.position.x+this.gapBetweenItems.x,y:e.item.position.y+this.gapBetweenItems.y,z:e.item.position.z+this.gapBetweenItems.z,duration:this.shuffleSpeed*.1,onComplete:()=>{ni=!1}}),t.selected&&(we=t.prev,t.selected=!1),t=t.prev}while(t.id!=Ze.id);mn=mn.prev,we.selected=!0,this.itemSelected=we.id,Lr=!1};Te.prototype.selectItem=function(){if(!this.opened||!this.enabled)return ni=!1;const r=we.node,t=we.action;Se.fromTo(r.item.scale,{x:1,y:1,z:1},{x:r.item.scale.x+this.resizeScale,y:r.item.scale.y+this.resizeScale,z:r.item.scale.z+this.resizeScale,duration:this.resizeSpeed*.1,yoyo:!0,repeat:1,onComplete:()=>{ni=!1,typeof t=="function"&&t()}})};Te.prototype.open=function(r=null){if(this.opened)return;let t=Ze;switch(this.openBehavior){case this.OPEN_GROW:do{const i=t.node;Se.to(i.item.scale,{x:t.properties.scale.x,y:t.properties.scale.y,z:t.properties.scale.z,duration:this.openTime,onComplete:()=>{i.enabled=!0}}),t=t.next}while(t.id!=Ze.id);break;case this.OPEN_TRANSPARENCY:let n=function(i,s,o,a,l,c=100){s.transparent=!0,s.opacity=o,Se.to(s,{opacity:a,duration:l,ease:"steps("+c+")",onComplete:()=>{i.enabled=!0}})};var e=n;do{const i=t.node;i.item.isGroup?i.item.traverse(s=>{s.isGroup||(Array.isArray(s.material)?s.material.forEach(o=>{n(i,o,0,1,this.openTime,100)}):n(i,s.material,0,1,this.openTime,100))}):Array.isArray(i.item.material)?i.item.material.forEach(s=>{n(i,s,0,1,this.openTime,100)}):n(i,i.item.material,0,1,this.openTime,100),t=t.next}while(t.id!=Ze.id);break}this.opened=this.enabled=!0,typeof r=="function"&&r()};Te.prototype.close=function(r=null){if(!this.opened)return;let t=Ze;do{const e=t.node;Se.to(e.item.scale,{x:0,y:0,z:0,duration:this.closeTime}),t=t.next}while(t.id!=Ze.id);this.opened=this.enabled=!1,typeof r=="function"&&r()};Te.prototype.moveMenu=function(r={}){if(!this.opened||!r)return;const t=r.duration&&typeof r.duration=="number"?r.duration:.5,e=r.x&&typeof r.x=="number"?r.x+this.menuOffsetItems.x:0+this.menuOffsetItems.x,n=r.y&&typeof r.y=="number"?r.y+this.menuOffsetItems.y:0+this.menuOffsetItems.y,i=r.z&&typeof r.z=="number"?r.z+this.menuOffsetItems.z:0+this.menuOffsetItems.z,s=r.rotateX&&typeof r.rotateX=="number"?r.rotateX:0,o=r.rotateY&&typeof r.rotateY=="number"?r.rotateY:0,a=r.rotateZ&&typeof r.rotateZ=="number"?r.rotateZ:0,l=r.scale&&typeof r.scale=="number"?r.scale:null,c=r.scaleX&&typeof r.scaleX=="number"?r.scaleX:1,u=r.scaleX&&typeof r.scaleX=="number"?r.scaleY:1,h=r.scaleX&&typeof r.scaleX=="number"?r.scaleZ:1,f={x:r.scale?l:c,y:r.scale?l:u,z:r.scale?l:h,duration:t};Se.to(this.itemGroup.position,{x:e,y:n,z:i,duration:t}),Se.to(this.itemGroup.rotation,{x:s,y:o,z:a,duration:t}),Se.to(this.itemGroup.scale,f)};Te.prototype.itemTransition=function(r={}){const t=r.duration&&typeof r.duration=="number"?r.duration:.5,e=r.scale&&typeof r.scale=="number"?r.scale:null,n=r.scaleX&&typeof r.scaleX=="number"?r.scaleX:1,i=r.scaleX&&typeof r.scaleX=="number"?r.scaleY:1,s=r.scaleX&&typeof r.scaleX=="number"?r.scaleZ:1,o=r.rotateX&&typeof r.rotateX=="number"?r.rotateX:0,a=r.rotateY&&typeof r.rotateY=="number"?r.rotateY:0,l=r.rotateZ&&typeof r.rotateZ=="number"?r.rotateZ:0,c={x:r.scale?e:n,y:r.scale?e:i,z:r.scale?e:s,duration:t},u=this.itemGroup.children;for(let h=0;h<u.length;h++){const f=u[h];Se.to(f.rotation,{x:o,duration:t}),Se.to(f.rotation,{y:a,duration:t}),Se.to(f.rotation,{z:l,duration:t}),Se.to(f.scale,c)}};Te.prototype.resetMenu=function(){this.moveMenu({}),this.itemTransition({})};Te.prototype.clickItem=function(r){if(!this.opened||Nl||!r)return;Aa.x=isNaN(r.clientX)?0:r.clientX/window.innerWidth*2-1,Aa.y=isNaN(r.clientY)?0:-(r.clientY/window.innerHeight)*2+1,Ju.setFromCamera(Aa,this.camera);const t=Ju.intersectObjects(this.itemGroup.children);if(t.length){const e=t[0].object;if(we.id===e.itemTag)this.selectItem();else if(ju(we,mn,e.itemTag)){if(this.moveToNext(),we.id!=e.itemTag){const n=setInterval(()=>{this.moveToNext(),we.id==e.itemTag&&clearInterval(n)},this.itemCount*.1+200*this.shuffleSpeed)}}else if(ju(we,pn,e.itemTag,!0)&&(this.moveToPrev(),we.id!=e.itemTag)){const n=setInterval(()=>{this.moveToPrev(),we.id==e.itemTag&&clearInterval(n)},this.itemCount*.1+200*this.shuffleSpeed)}}};function ju(r,t,e,n=!1){const i=t;let s=r;for(;s.id!=i.id;){if(s.id==e)return!0;n?s=s.prev:s=s.next}return s.id==e}Te.prototype.registerEvents=function(){let r;window.addEventListener("keydown",t=>{if(!(ni||!this.enabled))switch(ni=!0,t.key){case this.prevKey:this.moveToPrev();break;case this.nextKey:this.moveToNext();break;case this.selectKey:this.selectItem();break;default:ni=!1;break}}),window.addEventListener("pointerup",t=>{r&&(Nl=!1,clearTimeout(r)),r=setTimeout(()=>{this.clickItem(t),Nl=!0},100)})};function jx(r,t,e){this.id=e,this.node=r,this.selected=!1,this.action=t,this.next=null,this.prev=null,this.properties={}}const Qx="/assets",ty=Qx+"/fonts",tn={bkShade:46405,bgShade:17733,black:0,white:16777215},ey=ty+"/Nihonium113.typeface.json",Vt={width:window.innerWidth,height:window.innerHeight},wo={x:4,y:3},Kt={x:wo.x/Vt.width,y:wo.y/Vt.height};let xn=.002,oo=.002;const ny=document.querySelector("canvas.webgl"),vc=new q0({canvas:ny});vc.setSize(Vt.width,Vt.height);const $r=new Y0,sn=new ql(Vt.width/-2*xn,Vt.width/2*xn,Vt.height/2*xn,Vt.height/-2*xn,.1,1e3),Be=new ql(Vt.width/-2*oo,Vt.width/2*oo,Vt.height/2*oo,Vt.height/-2*oo,.1,1e3);let kf=sn;sn.updateProjectionMatrix();Be.updateProjectionMatrix();$r.add(sn,Be);sn.position.z=2;Be.position.z=2;window.addEventListener("resize",r=>{Vt.width=window.innerWidth,Vt.height=window.innerHeight,vc.setSize(Vt.width,Vt.height),Kt.x=wo.x/Vt.width,Kt.y=wo.y/Vt.height,Be.left=sn.left=Vt.width/-2*xn,Be.right=sn.right=Vt.width/2*xn,Be.top=sn.top=Vt.height/2*xn,Be.bottom=sn.bottom=Vt.height/-2*xn,sn.updateProjectionMatrix(),Be.updateProjectionMatrix()});function us(){const r=Vt.width>Vt.height+Vt.height*.3;return!!(screen.orientation.type.includes("landscape")&&r)}function iy(){let r={openBehavior:1,openTime:2,gapBetweenItems:{x:0,y:1,z:0},menuOffsetItems:{x:-2.5+Kt.y,y:0,z:0},nextKey:"ArrowUp",prevKey:"ArrowDown"};if(!us()){const t=Vt.height*Vt.width/1e4,n=-2+Kt.x*t;r={openBehavior:1,openTime:2,gapBetweenItems:{x:1,y:0,z:0},menuOffsetItems:{x:0,y:n,z:0}}}return r}const Ol=new Ql,ry=new Iv,ae=new Te($r,Be,iy());ae.cameraDistance=3;ae.defaultSpeed=.5;ae.shuffleSpeed=1;ae.reload();const wa=new nn,Qu=new nn,th=new nn,Oe={home:new nn,about:new nn,resume:new nn,projects:new nn,downloads:new nn};let Zi=null,yi=null,Fe={home:null,about:null,projects:null,resume:null,downloads:null};function sy(){return new Promise(function(r,t){ry.load(ey,e=>{const n=new ye(new Fi("BITKNVS STUDIO",{font:e,size:.3-Kt.x-Kt.y,depth:.1}).center(),new en({color:tn.bkShade})),i=new Date().getFullYear(),s=new ye(new Fi(i.toString(),{font:e,size:.1-Kt.x-Kt.y,depth:.1}).center(),new en({color:tn.bkShade}));let o=n.geometry.boundingBox.max.x-n.geometry.boundingBox.min.x,a=n.geometry.boundingBox.max.y-n.geometry.boundingBox.min.y;s.geometry.boundingBox.max.x-s.geometry.boundingBox.min.x;const l=s.geometry.boundingBox.max.y-s.geometry.boundingBox.min.y;n.position.z=-.2,s.position.z=-.2,n.position.x=-o,s.position.x=-o,s.position.y=l-a,Qu.add(n,s);function c(u){let h=u.boundingBox.max.x-u.boundingBox.min.x+.1,f=u.boundingBox.max.y-u.boundingBox.min.y+.1,p=new ye(new Zr(h,f),new en({color:tn.black,transparent:!0,opacity:0,depthWrite:!1}));return p.position.z=-.1,p}Fe.home=new Fi("HOME",{font:e,size:.13-Kt.x-Kt.y,depth:.1}).center(),Oe.home.add(c(Fe.home)),Fe.about=new Fi("ABOUT ME",{font:e,size:.13-Kt.x-Kt.y,depth:.1}).center(),Oe.about.add(c(Fe.about)),Fe.projects=new Fi("PROJECTS",{font:e,size:.13-Kt.x-Kt.y,depth:.1}).center(),Oe.projects.add(c(Fe.projects)),Fe.resume=new Fi("RESUME",{font:e,size:.13-Kt.x-Kt.y,depth:.1}).center(),Oe.resume.add(c(Fe.resume)),Fe.downloads=new Fi("DOWNLOADS",{font:e,size:.13-Kt.x-Kt.y,depth:.1}).center(),Oe.downloads.add(c(Fe.downloads)),cy(),r(Qu)})})}function oy(){Zi=new ye(new Zr(10-Kt.x,.5-Kt.y).center(),new en({color:tn.black})),Zi.position.z=-.1,Zi.position.x=-4.95-Kt.x,yi=new ye(new $l(.1,110,110),new en({color:tn.bgShade,wireframe:!0})),yi.material.transparent=!0,yi.material.opacity=0,th.add(Zi,yi),$r.add(th)}function ay(){let r=null;function t(o,a,l,c,u,h,f=!1){const p=a,g=l,_=new ds;_.moveTo(o.x,o.y),f?(_.lineTo(o.x,g+o.y),_.lineTo(p+o.x,g+o.y),_.lineTo(o.x,o.y)):(_.lineTo(p+o.x,o.y),_.lineTo(p+o.x,g+o.y),_.lineTo(o.x,o.y));const m={steps:1,depth:c,bevelEnabled:!1},d=new Io(_,m);d.center();const E=new ye(d,new en({color:tn.bkShade}));return E.position.x=u,E.position.y=h,E}const e=t({x:-.12,y:.02},.2,-.2,.15,-.11,.11),n=t({x:.12,y:.02},-.2,.2,.15,.11,.11,!0),i=t({x:.12,y:-.02},.2,.2,.15,.11,-.11,!0),s=t({x:-.12,y:-.02},-.2,-.2,.15,-.11,-.11);wa.add(e,n,i,s),r=Ol.add(e,2e3,{action:()=>{const o=Se.timeline(),a=xn+Kt.x;xn=a;const l=3;o.to(e.rotation,{z:Math.PI*-.5,duration:.5}).to(n.rotation,{z:Math.PI*.5,duration:.5}).to(i.rotation,{z:Math.PI*.5,duration:.5}).to(s.rotation,{z:Math.PI*-.5,duration:.5}).to(sn,{left:Vt.width/-2*a,right:Vt.width/2*a,top:Vt.height/2*a,bottom:Vt.height/-2*a,duration:l,onStart:()=>{Se.to(wa.position,{x:-1,duration:l}),Se.to(Zi.position,{x:-5.95,duration:l})},onUpdate:()=>{sn.updateProjectionMatrix()}})},duration:.5,delay:5e3}),r&&console.log(r),$r.add(wa)}function ly(){function r(t){$r.add(t);const e=xn+Math.max(.0045,Kt.x),n=Ol.add(t,5e3,{action:()=>{Se.timeline().to(t.position,{x:2.6,duration:3}).to(sn,{left:Vt.width/-2*e,right:Vt.width/2*e,top:Vt.height/2*e,bottom:Vt.height/-2*e,duration:1,onStart:()=>{uy(Zi),Zi=null,Se.to(yi.material,{opacity:.2,duration:1.5}),Se.to(yi.scale,{x:100,y:100,z:100,duration:1.5,ease:"power1.in"})},onUpdate:()=>{sn.updateProjectionMatrix()},onComplete:()=>{ae.open(),Be.left=Vt.width/-2*e,Be.right=Vt.width/2*e,Be.top=Vt.height/2*e,Be.bottom=Vt.height/-2*e,xn=e,Be.updateProjectionMatrix(),kf=Be,bkObj&&bkObj.loadPageElements()}})},duration:1,delay:1});n&&console.log(n),Ol.start()}sy().then(t=>{r(t)})}function cy(){const r=new $t(tn.bkShade),t=new $t(tn.white);function e(i,s){if(!s.selected)return;const o=s.item.children[1];s.item.scale.set(1,1,1),o.material.color=r}function n(i,s){if(s.selected)return;const o=s.item.children[1];s.item.scale.set(2,2,2),o.material.color=t}Oe.home.add(new ye(Fe.home,new en({color:tn.bkShade}))),ae.add(Oe.home,()=>{ae.resetMenu(),bkObj.showPanel("#home")},{animateSelect:n,animateDefault:e}),Oe.about.add(new ye(Fe.about,new en({color:tn.bkShade}))),ae.add(Oe.about,()=>{us()?ae.moveMenu({x:-.5+Kt.x}):ae.moveMenu({y:-1.3+Kt.x*50}),ae.itemTransition(),bkObj.showPanel("#about")},{animateSelect:n,animateDefault:e}),Oe.resume.add(new ye(Fe.resume,new en({color:tn.bkShade}))),ae.add(Oe.resume,()=>{us()?ae.moveMenu({x:-.5+Kt.x}):ae.moveMenu({y:-1.3+Kt.x*50}),ae.itemTransition(),bkObj.showPanel("#resume")},{animateSelect:n,animateDefault:e}),Oe.projects.add(new ye(Fe.projects,new en({color:tn.bkShade}))),ae.add(Oe.projects,()=>{us()?(ae.moveMenu({x:2.5-Kt.x,y:-2.2,z:-2,rotateZ:Math.PI*-.5}),ae.itemTransition({rotateZ:Math.PI*.5,scale:.8})):ae.moveMenu({y:-1.3+Kt.x*50}),bkObj.showPanel("#projects")},{animateSelect:n,animateDefault:e}),Oe.downloads.add(new ye(Fe.downloads,new en({color:tn.bkShade}))),ae.add(Oe.downloads,()=>{us()?ae.moveMenu({x:-.5+Kt.x}):ae.moveMenu({y:-1.3+Kt.x*50}),ae.itemTransition(),bkObj.showPanel("#downloads")},{animateSelect:n,animateDefault:e})}function uy(r){r.geometry&&r.geometry.dispose(),r.material&&(Array.isArray(r.material)?r.material.forEach(t=>t.dispose()):r.material.dispose()),r.parent&&r.parent.remove(r)}oy();ay();ly();const hy=new Pv,eh=.01;function fy(r){yi.rotation.x=Math.PI+r*eh,yi.rotation.y=Math.PI+r*eh}function Vf(){const r=hy.getElapsedTime();ae.animate(r),fy(r),vc.render($r,kf),window.requestAnimationFrame(Vf)}Vf();
